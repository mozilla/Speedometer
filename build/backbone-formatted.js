// THIS FILE IS AUTOGENERATED FROM ../resources/todomvc/architecture-examples/backbone/index.js
...
statsTemplate.innerHTML = `<span class="todo-count"><strong><%= remaining %></strong> <%= remaining === 1 ? 'item' : 'items' %> left</span>
            <ul class="filters">
                <li>
...
})(jQuery); /* eslint no-unused-vars: 0 */
