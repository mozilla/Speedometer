...
// Load contents of ../resources/todomvc/architecture-examples/angular/shell-polyfill-hack.js // Helper class for debugging
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
          ...
          for (
            ...
            __webpack_require__.o(installedChunks, (chunkId = chunkIds[i])) &&
              installedChunks[chunkId] &&
              installedChunks[chunkId][0](),
              (installedChunks[chunkId] = 0);
          return __webpack_require__.O(result);
        },
        chunkLoadingGlobal = (self.webpackChunkangular =
    ...
    583: () => {
      !(function (global2) {
        ...
        const checkDuplicate =
          !0 === global2[__symbol__("forceDuplicateZoneCheck")];
        if (global2.Zone) {
          if (checkDuplicate || "function" != typeof global2.Zone.__symbol__)
          ...
          class Zone3 {
            ...
            runTask(task, applyThis, applyArgs) {
              ...
              try {
                ...
                task.state !== notScheduled &&
                  task.state !== unknown &&
                  (task.type == eventTask || (task.data && task.data.isPeriodic)
        ...
        class ZoneTask {
          constructor(type, source, callback, options, scheduleFn, cancelFn) {
            ...
            const self2 = this;
            this.invoke =
              type === eventTask && options && options.useG
                ? ZoneTask.invokeTask
                : function () {
          ...
          static invokeTask(task, target, args) {
            ...
            try {
              ...
              1 == _numberOfNestedTaskFrames && drainMicroTaskQueue(),
          ...
          _transitionTo(toState, fromState1, fromState2) {
            ...
            (this._state = toState),
              toState == notScheduled && (this._zoneDelegates = null);
          }
          toString() {
        ...
        const symbolSetTimeout = __symbol__("setTimeout"),
          symbolPromise = __symbol__("Promise"),
          symbolThen = __symbol__("then");
        ...
        function nativeScheduleMicroTask(func) {
          if (
            (nativeMicroTaskQueuePromise ||
              (global2[symbolPromise] &&
                (nativeMicroTaskQueuePromise =
                  global2[symbolPromise].resolve(0))),
            nativeMicroTaskQueuePromise)
          ) {
            let nativeThen = nativeMicroTaskQueuePromise[symbolThen];
            nativeThen || (nativeThen = nativeMicroTaskQueuePromise.then),
              nativeThen.call(nativeMicroTaskQueuePromise, func);
          } else global2[symbolSetTimeout](func, 0);
        }
        function scheduleMicroTask(task) {
          0 === _numberOfNestedTaskFrames &&
            0 === _microTaskQueue.length &&
        ...
        const NO_ZONE = {
          ...
          _api = {
            ...
            scheduleMicroTask,
            showUncaughtError: () =>
              !Zone2[__symbol__("ignoreConsoleErrorUncaughtError")],
            patchEventTarget: () => [],
      ...
      const ObjectGetOwnPropertyDescriptor = Object.getOwnPropertyDescriptor,
        ...
        ZONE_SYMBOL_REMOVE_EVENT_LISTENER = Zone.__symbol__(
          "removeEventListener"
        ),
      ...
      const zoneSymbol = Zone.__symbol__,
        isWindowExists = typeof window < "u",
      ...
      function isPropertyWritable(propertyDesc) {
        return (
          !propertyDesc ||
          (!1 !== propertyDesc.writable &&
            !(
              "function" == typeof propertyDesc.get &&
              typeof propertyDesc.set > "u"
            ))
        );
      }
      const isWebWorker =
        ...
        isNode =
          !("nw" in _global) &&
          typeof _global.process < "u" &&
          "[object process]" === {}.toString.call(_global.process),
        isBrowser =
          !isNode &&
          !isWebWorker &&
        ...
        wrapFn = function (event) {
          if (!(event = event || _global.event)) return;
          let eventNameSymbol = zoneSymbolEventNames$1[event.type];
          eventNameSymbol ||
            (eventNameSymbol = zoneSymbolEventNames$1[event.type] =
              zoneSymbol("ON_PROPERTY" + event.type));
          const target = this || event.target || _global,
            listener = target[eventNameSymbol];
          let result;
          if (
            isBrowser &&
            ...
            (result = listener && listener.apply(this, arguments)),
              null != result && !result && event.preventDefault();
          return result;
        };
      function patchProperty(obj, prop, prototype) {
        ...
        if (
          (!desc &&
            prototype &&
            ObjectGetOwnPropertyDescriptor(prototype, prop) &&
            (desc = {
              enumerable: !0,
              configurable: !0,
            }),
        ...
        const originalDescGet = desc.get,
          originalDescSet = desc.set,
          eventName = prop.slice(2);
        let eventNameSymbol = zoneSymbolEventNames$1[eventName];
        eventNameSymbol ||
          (eventNameSymbol = zoneSymbolEventNames$1[eventName] =
            zoneSymbol("ON_PROPERTY" + eventName)),
          (desc.set = function (newValue) {
            let target = this;
            !target && obj === _global && (target = _global),
              target &&
                ("function" == typeof target[eventNameSymbol] &&
                  target.removeEventListener(eventName, wrapFn),
                originalDescSet && originalDescSet.call(target, null),
                (target[eventNameSymbol] = newValue),
                "function" == typeof newValue &&
                  target.addEventListener(eventName, wrapFn, !1));
          }),
          (desc.get = function () {
            let target = this;
            if ((!target && obj === _global && (target = _global), !target))
              return null;
            ...
            if (originalDescGet) {
              ...
              if (value)
                return (
                  ...
                  "function" == typeof target.removeAttribute &&
      ...
      function patchOnProperties(obj, properties, prototype) {
        if (properties)
          ...
          for (const prop in obj)
            "on" == prop.slice(0, 2) && onProperties.push(prop);
      ...
      function patchClass(className) {
        ...
        for (prop in instance)
          ("XMLHttpRequest" === className && "responseBlob" === prop) ||
            (function (prop2) {
              "function" == typeof instance[prop2]
                ...
                : ObjectDefineProperty(_global[className].prototype, prop2, {
                    set: function (fn) {
                      "function" == typeof fn
                        ? ((this[originalInstanceKey][prop2] =
                            wrapWithCurrentZone(fn, className + "." + prop2)),
        ...
        for (prop in OriginalClass)
          "prototype" !== prop &&
            OriginalClass.hasOwnProperty(prop) &&
            (_global[className][prop] = OriginalClass[prop]);
      }
      function patchMethod(target, name, patchFn) {
        let proto = target;
        for (; proto && !proto.hasOwnProperty(name); )
        ...
        if (
          ...
          isPropertyWritable(
            proto && ObjectGetOwnPropertyDescriptor(proto, name)
          ))
        ) {
        ...
        setNative = patchMethod(
          ...
          (delegate) =>
            function (self2, args) {
              ...
              return meta.cbIdx >= 0 && "function" == typeof args[meta.cbIdx]
      ...
      Zone.__load_patch("ZoneAwarePromise", (global2, Zone2, api) => {
        const ObjectGetOwnPropertyDescriptor2 = Object.getOwnPropertyDescriptor,
          ObjectDefineProperty2 = Object.defineProperty,
          __symbol__ = api.symbol,
          _uncaughtPromiseErrors = [],
          isDisableWrappingUncaughtPromiseRejection =
            !0 ===
            global2[__symbol__("DISABLE_WRAPPING_UNCAUGHT_PROMISE_REJECTION")],
          symbolPromise = __symbol__("Promise"),
          symbolThen = __symbol__("then");
            ...
            for (; _uncaughtPromiseErrors.length; ) {
              ...
              try {
                uncaughtPromiseError.zone.runGuarded(() => {
                  throw uncaughtPromiseError.throwOriginal
                    ? uncaughtPromiseError.rejection
        ...
        const symbolState = __symbol__("state"),
          symbolValue = __symbol__("value"),
          symbolFinally = __symbol__("finally"),
          symbolParentPromiseValue = __symbol__("parentPromiseValue"),
        ...
        const once = function () {
            ...
            return function (wrappedFunction) {
              return function () {
                wasCalled ||
                  ((wasCalled = !0), wrappedFunction.apply(null, arguments));
              };
            };
          },
        ...
        function resolvePromise(promise, state, value) {
          ...
          if (null === promise[symbolState]) {
            ...
            if (
              ...
              null !== value[symbolState]
            )
              clearRejectedNoCatch(value),
                resolvePromise(promise, value[symbolState], value[symbolValue]);
            else if (!1 !== state && "function" == typeof then)
              try {
                then.call(
                  value,
                  onceWrapper(makeResolver(promise, state)),
                  onceWrapper(makeResolver(promise, !1))
                );
              } catch (err) {
                onceWrapper(() => {
                  resolvePromise(promise, !1, err);
              ...
              if (
                ...
                promise[symbolFinally] === symbolFinally &&
                  !0 === state &&
                  ((promise[symbolState] = promise[symbolParentPromiseState]),
                  (promise[symbolValue] = promise[symbolParentPromiseValue])),
                !1 === state && value instanceof Error)
              ) {
                const trace =
                  Zone2.currentTask &&
                  Zone2.currentTask.data &&
                  Zone2.currentTask.data.__creationTrace__;
                trace &&
              ...
              if (0 == queue.length && 0 == state) {
                ...
                isDisableWrappingUncaughtPromiseRejection &&
                  (uncaughtPromiseError.throwOriginal = !0),
        ...
        function clearRejectedNoCatch(promise) {
          if (0 === promise[symbolState]) {
            ...
            for (let i = 0; i < _uncaughtPromiseErrors.length; i++)
              promise === _uncaughtPromiseErrors[i].promise &&
        ...
        const noop = function () {},
          AggregateError = global2.AggregateError;
        class ZoneAwarePromise {
          ...
          static any(values) {
            if (!values || "function" != typeof values[Symbol.iterator])
            ...
            try {
              for (let v of values)
                count++, promises.push(ZoneAwarePromise.resolve(v));
            } catch {
              return Promise.reject(
                new AggregateError([], "All promises were rejected")
              );
          ...
          constructor(executor) {
            ...
            try {
              ...
              executor &&
                executor(
                  onceWrapper(makeResolver(promise, !0)),
                  onceWrapper(makeResolver(promise, !1))
                );
            } catch (error) {
          ...
          then(onFulfilled, onRejected) {
            var _a;
            let C =
              null === (_a = this.constructor) || void 0 === _a
                ? void 0
                : _a[Symbol.species];
            (!C || "function" != typeof C) &&
        ...
        function patchThen(Ctor) {
          const proto = Ctor.prototype,
            prop = ObjectGetOwnPropertyDescriptor2(proto, "then");
        ...
        return (
          ...
          NativePromise &&
            ...
            patchMethod(global2, "fetch", (delegate) =>
              (function zoneify(fn) {
                return function (self2, args) {
                  ...
                  return (
                    ctor[symbolThenPatched] || patchThen(ctor), resultPromise
                  );
                };
              })(delegate)
            )),
          (Promise[Zone2.__symbol__("uncaughtPromiseErrors")] =
            _uncaughtPromiseErrors),
          ZoneAwarePromise
        );
      }),
        Zone.__load_patch("toString", (global2) => {
          const originalFunctionToString = Function.prototype.toString,
            ORIGINAL_DELEGATE_SYMBOL = zoneSymbol("OriginalDelegate"),
            PROMISE_SYMBOL = zoneSymbol("Promise"),
            ERROR_SYMBOL = zoneSymbol("Error"),
            newFunctionToString = function () {
              if ("function" == typeof this) {
                const originalDelegate = this[ORIGINAL_DELEGATE_SYMBOL];
                if (originalDelegate)
                  return "function" == typeof originalDelegate
                    ? originalFunctionToString.call(originalDelegate)
                    : Object.prototype.toString.call(originalDelegate);
                if (this === Promise) {
          ...
          Object.prototype.toString = function () {
            return "function" == typeof Promise && this instanceof Promise
              ? "[object Promise]"
              : originalObjectToString.call(this);
          };
        });
      ...
      const OPTIMIZED_ZONE_EVENT_TASK_DATA = {
        ...
        globalSources = {},
        EVENT_NAME_SYMBOL_REGX = new RegExp(
      ...
      function prepareEventNames(eventName, eventNameToString) {
        const falseEventName =
          ...
          trueEventName =
            (eventNameToString ? eventNameToString(eventName) : eventName) +
            "true",
          symbol = ZONE_SYMBOL_PREFIX + falseEventName,
          symbolCapture = ZONE_SYMBOL_PREFIX + trueEventName;
      ...
      function patchEventTarget(_global2, api, apis, patchOptions) {
        const ADD_EVENT_LISTENER =
            (patchOptions && patchOptions.add) || "addEventListener",
          REMOVE_EVENT_LISTENER =
            (patchOptions && patchOptions.rm) || "removeEventListener",
          ...
          zoneSymbolAddEventListener = zoneSymbol(ADD_EVENT_LISTENER),
          ADD_EVENT_LISTENER_SOURCE = "." + ADD_EVENT_LISTENER + ":",
          invokeTask = function (task, target, event) {
            if (task.isRemoved) return;
            const delegate = task.callback;
            let error;
            "object" == typeof delegate &&
        ...
        function globalCallback(context, event, isCapture) {
          ...
          const target = context || event.target || _global2,
            tasks =
              target[
                zoneSymbolEventNames[event.type][isCapture ? "true" : "false"]
              ];
          if (tasks) {
            const errors = [];
            if (1 === tasks.length) {
              ...
              for (
                let i = 0;
                i < copyTasks.length &&
                (!event || !0 !== event[IMMEDIATE_PROPAGATION_SYMBOL]);
                i++
              ) {
        ...
        function patchEventTargetMethods(obj, patchOptions2) {
          ...
          patchOptions2 &&
            void 0 !== patchOptions2.useG &&
            (useGlobalCallback = patchOptions2.useG);
          const validateHandler = patchOptions2 && patchOptions2.vh;
          let checkDuplicate = !0;
          patchOptions2 &&
            void 0 !== patchOptions2.chkDup &&
            (checkDuplicate = patchOptions2.chkDup);
          let returnTarget = !1;
          patchOptions2 &&
            void 0 !== patchOptions2.rt &&
            (returnTarget = patchOptions2.rt);
          let proto = obj;
          for (; proto && !proto.hasOwnProperty(ADD_EVENT_LISTENER); )
            proto = ObjectGetPrototypeOf(proto);
          if (
            (!proto && obj[ADD_EVENT_LISTENER] && (proto = obj),
            !proto || proto[zoneSymbolAddEventListener])
          )
            return !1;
          const eventNameToString =
              patchOptions2 && patchOptions2.eventNameToString,
            taskData = {},
            nativeAddEventListener = (proto[zoneSymbolAddEventListener] =
              proto[ADD_EVENT_LISTENER]),
            nativeRemoveEventListener = (proto[
              zoneSymbol(REMOVE_EVENT_LISTENER)
            ] = proto[REMOVE_EVENT_LISTENER]),
            nativeListeners = (proto[zoneSymbol(LISTENERS_EVENT_LISTENER)] =
          ...
          function buildEventListenerOptions(options, passive) {
            return !passiveSupported && "object" == typeof options && options
              ? !!options.capture
              : passiveSupported && passive
              ? "boolean" == typeof options
                ...
                : options
                ? "object" == typeof options && !1 !== options.passive
          ...
          patchOptions2 &&
            patchOptions2.prepend &&
            (nativePrependEventListener = proto[
              zoneSymbol(patchOptions2.prepend)
            ] =
          ...
          const customSchedule = useGlobalCallback
            ...
            customCancel = useGlobalCallback
              ? function (task) {
                  if (!task.isRemoved) {
                    const symbolEventNames =
                      zoneSymbolEventNames[task.eventName];
                    let symbolEventName;
                    symbolEventNames &&
                      (symbolEventName =
                        symbolEventNames[task.capture ? "true" : "false"]);
                    const existingTasks =
                      symbolEventName && task.target[symbolEventName];
                    if (existingTasks)
                      for (let i = 0; i < existingTasks.length; i++)
                        if (existingTasks[i] === task) {
                          existingTasks.splice(i, 1),
                            (task.isRemoved = !0),
                            0 === existingTasks.length &&
                              ((task.allRemoved = !0),
            ...
            compare =
              patchOptions2 && patchOptions2.diff
                ? patchOptions2.diff
                : function (task, delegate) {
                    const typeOfDelegate = typeof delegate;
                    return (
                      ("function" === typeOfDelegate &&
                        task.callback === delegate) ||
                      ("object" === typeOfDelegate &&
                        task.originalDelegate === delegate)
                    );
                  },
            unpatchedEvents = Zone[zoneSymbol("UNPATCHED_EVENTS")],
            passiveEvents = _global2[zoneSymbol("PASSIVE_EVENTS")],
            makeAddListener = function (
              ...
              return function () {
                ...
                patchOptions2 &&
                  patchOptions2.transferEventName &&
                ...
                const passive =
                    passiveSupported &&
                    !!passiveEvents &&
                    -1 !== passiveEvents.indexOf(eventName),
                  options = buildEventListenerOptions(arguments[2], passive);
                if (unpatchedEvents)
                ...
                const capture =
                    !!options &&
                    ("boolean" == typeof options || options.capture),
                  once =
                    !(!options || "object" != typeof options) && options.once,
                  zone = Zone.current;
                ...
                const symbolEventName =
                  symbolEventNames[capture ? "true" : "false"];
                let source,
                ...
                if (existingTasks) {
                  if (((isExisting = !0), checkDuplicate))
                    for (let i = 0; i < existingTasks.length; i++)
                      if (compare(existingTasks[i], delegate)) return;
                } else existingTasks = target[symbolEventName] = [];
                const constructorName = target.constructor.name,
                  targetSource = globalSources[constructorName];
                targetSource && (source = targetSource[eventName]),
                  source ||
                    (source =
                      constructorName +
                      addSource +
                ...
                return (
                  ...
                  once && (options.once = !0),
                  (!passiveSupported && "boolean" == typeof task.options) ||
                    (task.options = options),
                  (task.target = target),
                  (task.capture = capture),
                  (task.eventName = eventName),
                  isHandleEvent && (task.originalDelegate = delegate),
                  prepend
                    ? existingTasks.unshift(task)
                    : existingTasks.push(task),
                  returnTarget2 ? target : void 0
                );
              };
            };
          return (
            ...
            nativePrependEventListener &&
              (proto.prependListener = makeAddListener(
                nativePrependEventListener,
                ".prependListener:",
                function (task) {
            ...
            (proto[REMOVE_EVENT_LISTENER] = function () {
              ...
              const options = arguments[2],
                capture =
                  !!options && ("boolean" == typeof options || options.capture),
              ...
              if (existingTasks)
                for (let i = 0; i < existingTasks.length; i++) {
                  ...
                  if (compare(existingTask, delegate))
                    return (
                      existingTasks.splice(i, 1),
                      (existingTask.isRemoved = !0),
                      0 === existingTasks.length &&
                        ((existingTask.allRemoved = !0),
            ...
            (proto[REMOVE_ALL_LISTENERS_EVENT_LISTENER] = function () {
              ...
              if (eventName) {
                ...
                const symbolEventNames = zoneSymbolEventNames[eventName];
                if (symbolEventNames) {
                  const tasks = target[symbolEventNames.false],
                    captureTasks = target[symbolEventNames.true];
                  if (tasks) {
      ...
      function findEventTasks(target, eventName) {
        ...
        const captureFalseTasks = target[symbolEventName.false],
          captureTrueTasks = target[symbolEventName.true];
        return captureFalseTasks
          ? captureTrueTasks
            ? captureFalseTasks.concat(captureTrueTasks)
            : captureFalseTasks.slice()
          : captureTrueTasks
          ? captureTrueTasks.slice()
          : [];
      }
      function patchEventPrototype(global2, api) {
        ...
        Event &&
          ...
          api.patchMethod(
            ...
            (delegate) =>
              function (self2, args) {
                (self2[IMMEDIATE_PROPAGATION_SYMBOL] = !0),
      ...
      Zone.__load_patch("util", (global2, Zone2, api) => {
        ...
        const SYMBOL_BLACK_LISTED_EVENTS = Zone2.__symbol__(
            "BLACK_LISTED_EVENTS"
          ),
          SYMBOL_UNPATCHED_EVENTS = Zone2.__symbol__("UNPATCHED_EVENTS");
        global2[SYMBOL_UNPATCHED_EVENTS] &&
          (global2[SYMBOL_BLACK_LISTED_EVENTS] =
            global2[SYMBOL_UNPATCHED_EVENTS]),
          global2[SYMBOL_BLACK_LISTED_EVENTS] &&
            (Zone2[SYMBOL_BLACK_LISTED_EVENTS] = Zone2[
            ...
            function (self2, args) {
              if ("function" == typeof args[0]) {
                const options = {
                    ...
                    delay:
                      "Timeout" === nameSuffix || "Interval" === nameSuffix
                        ? args[1] || 0
                        : void 0,
                    args,
                  },
                ...
                args[0] = function () {
                  try {
                    ...
                    options.isPeriodic ||
                      ("number" == typeof options.handleId
                ...
                return (
                  "number" == typeof handle
                    ...
                    : handle && (handle[taskSymbol] = task),
                  handle &&
                    handle.ref &&
                    handle.unref &&
                    "function" == typeof handle.ref &&
                    "function" == typeof handle.unref &&
                    ((task.ref = handle.ref.bind(handle)),
                    (task.unref = handle.unref.bind(handle))),
                  "number" == typeof handle || handle ? handle : task
                );
              }
            ...
            (delegate) =>
              function (self2, args) {
                ...
                "number" == typeof id
                  ...
                  : ((task = id && id[taskSymbol]), task || (task = id)),
                  task && "string" == typeof task.type
                    ? "notScheduled" !== task.state &&
                      ((task.cancelFn && task.data.isPeriodic) ||
                        0 === task.runCount) &&
                      ("number" == typeof id
                        ? delete tasksByHandleId[id]
                        : id && (id[taskSymbol] = null),
      ...
      Zone.__load_patch("legacy", (global2) => {
        ...
        Zone.__load_patch("EventTarget", (global2, Zone2, api) => {
            ...
            (function eventTargetPatch(_global2, api) {
              ...
              for (let i = 0; i < eventNames.length; i++) {
                const eventName = eventNames[i],
                  symbol = ZONE_SYMBOL_PREFIX2 + (eventName + FALSE_STR2),
                  symbolCapture = ZONE_SYMBOL_PREFIX2 + (eventName + TRUE_STR2);
              ...
              EVENT_TARGET &&
                EVENT_TARGET.prototype &&
                api.patchEventTarget(_global2, api, [
          ...
          XMLHttpRequestEventTarget &&
            ...
            api.patchEventTarget(global2, api, [
              XMLHttpRequestEventTarget.prototype,
            ]);
        }),
        ...
        Zone.__load_patch("customElements", (global2, Zone2, api) => {
          !(function patchCustomElements(_global2, api) {
            const { isBrowser: isBrowser2, isMix: isMix2 } =
              api.getGlobalObjects();
            (isBrowser2 || isMix2) &&
        ...
        Zone.__load_patch("XHR", (global2, Zone2) => {
          !(function patchXHR(window2) {
            ...
            if (!oriAddListener) {
              const XMLHttpRequestEventTarget =
                window2.XMLHttpRequestEventTarget;
            ...
            function scheduleTask(task) {
              const data = task.data,
                target = data.target;
              (target[XHR_SCHEDULED] = !1),
                (target[XHR_ERROR_BEFORE_SCHEDULED] = !1);
              ...
              oriAddListener ||
                ...
                listener &&
                  oriRemoveListener.call(target, "readystatechange", listener);
                  ...
                  if (
                    ...
                    if (
                      ...
                      (task.invoke = function () {
                        const loadTasks2 =
                          target[Zone2.__symbol__("loadfalse")];
                        for (let i = 0; i < loadTasks2.length; i++)
                          loadTasks2[i] === task && loadTasks2.splice(i, 1);
                        !data.aborted &&
                          "scheduled" === task.state &&
                          oriInvoke.call(task);
                      }),
                    ...
                    !data.aborted &&
                      !1 === target[XHR_SCHEDULED] &&
                      (target[XHR_ERROR_BEFORE_SCHEDULED] = !0);
              });
              return (
                oriAddListener.call(target, "readystatechange", newListener),
                target[XHR_TASK] || (target[XHR_TASK] = task),
                sendNative.apply(target, data.args),
                (target[XHR_SCHEDULED] = !0),
                task
              );
            }
            ...
            function clearTask(task) {
              const data = task.data;
              return (
                (data.aborted = !0), abortNative.apply(data.target, data.args)
              );
            }
            const openNative = patchMethod(
                ...
                () =>
                  function (self2, args) {
                    return (
                      (self2[XHR_SYNC] = 0 == args[2]),
                      (self2[XHR_URL] = args[1]),
                      openNative.apply(self2, args)
                    );
                  }
              ),
              fetchTaskAborting = zoneSymbol("fetchTaskAborting"),
              fetchTaskScheduling = zoneSymbol("fetchTaskScheduling"),
              sendNative = patchMethod(
                XMLHttpRequestPrototype,
                "send",
                () =>
                  function (self2, args) {
                    if (
                      !0 === Zone2.current[fetchTaskScheduling] ||
                      self2[XHR_SYNC]
                    )
                      return sendNative.apply(self2, args);
                    {
                      const options = {
                        ...
                        task = scheduleMacroTaskWithCurrentZone(
                          "XMLHttpRequest.send",
                          placeholderCallback,
                          options,
                          scheduleTask,
                      ...
                      self2 &&
                        !0 === self2[XHR_ERROR_BEFORE_SCHEDULED] &&
                        !options.aborted &&
                        "scheduled" === task.state &&
                        task.invoke();
                    }
                  ...
                  function (self2, args) {
                    ...
                    if (task && "string" == typeof task.type) {
                      if (
                        ...
                        return;
                      task.zone.cancelTask(task);
                    } else if (!0 === Zone2.current[fetchTaskAborting])
          ...
          const XHR_TASK = zoneSymbol("xhrTask"),
            ...
            XHR_LISTENER = zoneSymbol("xhrListener"),
            XHR_SCHEDULED = zoneSymbol("xhrScheduled"),
            XHR_URL = zoneSymbol("xhrURL"),
            XHR_ERROR_BEFORE_SCHEDULED = zoneSymbol("xhrErrorBeforeScheduled");
        }),
        Zone.__load_patch("geolocation", (global2) => {
          global2.navigator &&
            global2.navigator.geolocation &&
  ...
  [179],
  {
    677: () => {
          ...
          if ((super(), isFunction(observerOrNext) || !observerOrNext))
            ...
            this && config.useDeprecatedNextContext
              ? ((context2 = Object.create(observerOrNext)),
                ...
                (partialObserver = {
                  next:
                    observerOrNext.next && bind(observerOrNext.next, context2),
                  error:
                    observerOrNext.error &&
                    bind(observerOrNext.error, context2),
                  complete:
                    observerOrNext.complete &&
                    bind(observerOrNext.complete, context2),
                }))
      ...
      function getPromiseCtor(promiseCtor) {
        var _a;
        return null !== (_a = promiseCtor ?? config.Promise) && void 0 !== _a
          ? _a
          : Promise;
      }
      ...
      function innerFrom(input) {
        ...
        if (null != input) {
          ...
          if (isPromise(input))
            return (function fromPromise(promise2) {
              return new Observable_Observable((subscriber) => {
                promise2
                  .then(
                    (value) => {
            ...
            return (function __awaiter(thisArg, _arguments, P, generator) {
              ...
              try {
                for (
                  ...
                  if (
                    (subscriber.next(asyncIterable_1_1.value),
                    subscriber.closed)
                  )
                    return;
              } catch (e_1_1) {
        ...
        return scheduler
          ? (function scheduled(input, scheduler) {
              if (null != input) {
                ...
                if (isReadableStreamLike(input))
                  return (function scheduleReadableStreamLike(
                    input,
                    scheduler
                  ) {
      ...
      var InjectFlags = (() => (
        ((InjectFlags = InjectFlags || {})[(InjectFlags.Default = 0)] =
          "Default"),
      ...
      function injectRootLimpMode(token, notFoundValue, flags) {
        ...
        return injectableDef && "root" == injectableDef.providedIn
          ? void 0 === injectableDef.value
          ...
          ? notFoundValue
          : void throwProviderNotFoundError(stringify(token));
      }
        ...
        ViewEncapsulation$1 = (() => {
          return (
            ((ViewEncapsulation2 =
              ...
              (ViewEncapsulation2.Emulated = 0)
            ] = "Emulated"),
            (ViewEncapsulation2[(ViewEncapsulation2.None = 2)] = "None"),
            (ViewEncapsulation2[(ViewEncapsulation2.ShadowDom = 3)] =
              "ShadowDom"),
            ViewEncapsulation$1
          );
      ...
      function ɵɵdefineComponent(componentDefinition) {
        return noSideEffects(() => {
          const standalone = !0 === componentDefinition.standalone,
            declaredInputs = {},
            def = {
              ...
              standalone,
              dependencies:
                (standalone && componentDefinition.dependencies) || null,
      ...
      function rememberChangeHistoryAndInvokeOnChangesHook() {
        const simpleChangesStore = getSimpleChangesStore(this),
          current = simpleChangesStore?.current;
        if (current) {
      ...
      function getCurrentTNode() {
        ...
        for (; null !== currentTNode && 64 === currentTNode.type; )
      ...
      function callHooks(currentView, arr, initPhase, currentNodeIndex) {
        const nodeIndexLimit = currentNodeIndex ?? -1,
          max = arr.length - 1;
      ...
      function mergeHostAttrs(dst, src) {
        if (null !== src && 0 !== src.length)
          if (null === dst || 0 === dst.length) dst = src.slice();
          else {
            let srcMarker = -1;
      ...
      function notFoundValueOrThrow(notFoundValue, token, flags) {
        if (flags & InjectFlags.Optional || void 0 !== notFoundValue)
      ...
      function getOrCreateInjectable(
                  ...
                  if (!parentTNode) {
                    ...
                    if (embeddedViewInjector) {
                      const embeddedViewInjectorValue =
                        embeddedViewInjector.get(token, NOT_FOUND, flags);
                      if (embeddedViewInjectorValue !== NOT_FOUND)
                        return embeddedViewInjectorValue;
                    }
                    (parentTNode = getTNodeFromLView(currentLView)),
                      (currentLView = currentLView[15]);
                  }
        ...
        return lookupTokenUsingModuleInjector(
          lView,
          token,
          flags,
          notFoundValue
        ...
        if ("function" == typeof bloomHash) {
          if (!enterDI(lView, tNode, flags))
            return flags & InjectFlags.Host
              ? notFoundValueOrThrow(notFoundValue, 0, flags)
      ...
      function getNodeInjectable(lView, tView, index, tNode) {
        ...
        if (
          ...
          try {
            (value = lView[index] =
              factory.factory(void 0, tData, lView, tNode)),
              tView.firstCreatePass &&
                ...
                (function registerPreOrderHooks(
                  ...
                  if (ngOnChanges) {
                    const wrappedOnChanges =
                      NgOnChangesFeatureImpl(directiveDef);
      ...
      function bloomHasToken(bloomHash, injectorIndex, injectorView) {
        return !!(
          injectorView[injectorIndex + (bloomHash >> 5)] &
          (1 << bloomHash)
        );
      }
      ...
      function keyValueArrayIndexOf(keyValueArray, key) {
        return (function _arrayIndexOfSorted(array, value, shift) {
          let start = 0,
            end = array.length >> shift;
          for (; end !== start; ) {
            const middle = start + ((end - start) >> 1),
              current = array[middle << shift];
      ...
      function attachInjectFlag(decorator, flag) {
        return (
          (decorator.__NG_DI_FLAG__ = flag),
          (decorator.prototype.__NG_DI_FLAG__ = flag),
          decorator
        );
      }
      const core_Optional = attachInjectFlag(makeParamDecorator("Optional"), 8),
        SkipSelf = attachInjectFlag(makeParamDecorator("SkipSelf"), 4);
      ...
      function cleanUpView(tView, lView) {
        if (!(128 & lView[2])) {
          (lView[2] &= -65),
                ...
                for (let i = 0; i < tCleanup.length - 1; i += 2)
                  if ("string" == typeof tCleanup[i]) {
                    const idxOrTargetGetter = tCleanup[i + 1],
                      ...
                      listener =
                        lCleanup[(lastLCleanupIndex = tCleanup[i + 2])],
                    ...
                    "boolean" == typeof useCaptureOrSubIdx
                      ...
                      : lCleanup[
                          (lastLCleanupIndex = -useCaptureOrSubIdx)
                        ].unsubscribe(),
                      (i += 2);
                  } else {
                    const context2 =
                      lCleanup[(lastLCleanupIndex = tCleanup[i + 1])];
            ...
            1 === lView[1].type && lView[11].destroy();
      ...
      let core_DOCUMENT,
        _getInsertInFrontOfRNodeWithI18n =
          function getInsertInFrontOfRNodeWithNoI18n(
            parentTNode,
            currentTNode,
            lView
          ) {
            return 40 & parentTNode.type
      ...
      function appendChild(tView, lView, childRNode, childTNode) {
        const parentRNode = getParentRElement(tView, childTNode, lView),
          renderer = lView[11],
          anchorNode = (function getInsertInFrontOfRNode(
            parentTNode,
            currentTNode,
            lView
          ) {
            return _getInsertInFrontOfRNodeWithI18n(
              parentTNode,
              currentTNode,
              lView
            );
        ...
        if (null !== tNode) {
          ...
          if (32 & tNodeType)
            return (
              ...
              unwrapRNode(lView[tNode.index])
            );
          {
            const projectionNodes = getProjectionNodes(lView, tNode);
            return null !== projectionNodes
              ? Array.isArray(projectionNodes)
                ? projectionNodes[0]
                : getFirstNativeNode(getLViewParent(lView[16]), projectionNodes)
      ...
      function getProjectionNodes(lView, tNode) {
        return null !== tNode
          ? lView[16][6].projection[tNode.projection]
          : null;
      }
        ...
        for (; null != tNode; ) {
          ...
          if (
            (isProjection &&
              0 === action &&
              (rawSlotValue &&
                attachPatchData(unwrapRNode(rawSlotValue), lView),
              (tNode.flags |= 4)),
            64 != (64 & tNode.flags))
          )
            if (8 & tNodeType)
      ...
      function internalImportProvidersFrom(checkForStandaloneCmp, ...sources) {
        ...
        return (
          deepForEach(sources, (source) => {
            ...
            walkProviderTree(internalSource, providersOut, [], dedup) &&
              (injectorTypesWithProviders || (injectorTypesWithProviders = []),
              injectorTypesWithProviders.push(internalSource));
          }),
          void 0 !== injectorTypesWithProviders &&
      ...
      function walkProviderTree(container, providersOut, parents, dedup) {
        ...
        let defType = null,
          injDef = getInjectorDef(container);
        ...
        if (cmpDef) {
          ...
          if ((dedup.add(defType), cmpDef.dependencies)) {
            const deps =
              "function" == typeof cmpDef.dependencies
                ? cmpDef.dependencies()
                : cmpDef.dependencies;
            ...
            if (null != injDef.imports && !isDuplicate) {
              ...
              try {
                deepForEach(injDef.imports, (imported) => {
                  walkProviderTree(imported, providersOut, parents, dedup) &&
      ...
      function isValueProvider(value) {
        return (
          null !== value && "object" == typeof value && USE_VALUE$1 in value
        );
      }
      ...
      function getNullInjector() {
        return (
          void 0 === NULL_INJECTOR$1 && (NULL_INJECTOR$1 = new NullInjector()),
          NULL_INJECTOR$1
        );
      }
      ...
      class R3Injector extends EnvironmentInjector {
        constructor(providers, parent, source, scopes) {
          super(),
            ...
            scopes.has("environment") &&
              this.records.set(EnvironmentInjector, makeRecord(void 0, this));
          const record = this.records.get(INJECTOR_SCOPE);
          null != record &&
            "string" == typeof record.value &&
        ...
        get(
          ...
          try {
            ...
            return (
              flags & InjectFlags.Self ? getNullInjector() : this.parent
            ).get(
              token,
              (notFoundValue =
                flags & InjectFlags.Optional &&
            ...
            if ("NullInjectorError" === e.name) {
              if (
                ...
                throw e;
              return (function catchInjectorError(
                e,
                token,
                injectorErrorName,
                source
                ...
                throw (
                  ...
                  (e.message = (function formatError(
                    text,
                    obj,
                    injectorErrorName,
                    source = null
                    ...
                    return `${injectorErrorName}${
                      source ? "(" + source + ")" : ""
                    }[${context2}]: ${text.replace(NEW_LINE, "\n  ")}`;
        ...
        processProvider(provider) {
          ...
          const record = (function providerToRecord(provider) {
            return isValueProvider(provider)
              ...
              : makeRecord(providerToFactory(provider), NOT_YET);
          })(provider);
        ...
        injectableDefInScope(def) {
          ...
          return "string" == typeof providedIn
            ? "any" === providedIn || this.scopes.has(providedIn)
            : this.injectorDefTypes.has(providedIn);
        }
      }
      function injectableDefOrInjectorDefFactory(token) {
        ...
        if (token instanceof Function)
          return (function getUndecoratedInjectableFactory(token) {
            ...
            if (paramLength > 0)
              throw (
                ...
                new RuntimeError(204, !1))
              );
            const inheritedInjectableDef = (function getInheritedInjectableDef(
              type
            ) {
              const def =
                type && (type[NG_PROV_DEF] || type[NG_INJECTABLE_DEF]);
              if (def) {
      ...
      function forEachSingleProvider(providers, fn) {
        for (const provider of providers)
          Array.isArray(provider)
            ...
            : isImportedNgModuleProviders(provider)
      ...
      let ComponentFactoryResolver$1 = (() => {
        ...
        return (
          (ComponentFactoryResolver$12.NULL =
            new _NullComponentFactoryResolver()),
          ComponentFactoryResolver$12
        );
      })();
      ...
      let core_Renderer2 = (() => {
          class Renderer22 {}
          return (
            (Renderer22.__NG_ELEMENT_ID__ = () =>
              (function injectRenderer2() {
                const lView = getLView(),
                  nodeAtIndex = getComponentLViewByIndex(
                    getCurrentTNode().index,
                    lView
                  );
      ...
      function hasTagAndTypeMatch(tNode, currentSelector, isProjectionMode) {
        return (
          currentSelector ===
          (4 !== tNode.type || isProjectionMode ? tNode.value : "ng-template")
        );
      }
      ...
      function createInjectorWithoutInjectorInstances(
        ...
        return (
          (name =
            name || ("object" == typeof defType ? void 0 : stringify(defType))),
          new R3Injector(
            providers,
      ...
      function createLView(
        ...
        return (
          (lView[0] = host),
          (lView[2] = 76 | flags),
          (null !== embeddedViewInjector ||
            (parentLView && 1024 & parentLView[2])) &&
            (lView[2] |= 1024),
          ...
          (lView[6] = tHostNode),
          (lView[20] = (function getUniqueLViewId() {
            return uniqueIdCounter++;
          })()),
          (lView[21] = embeddedViewInjector),
      ...
      function getOrCreateTNode(tView, index, type, name, attrs) {
        ...
        if (null === tNode)
          (tNode = (function createTNodeAtIndex(
            tView,
            index,
            type,
            name,
            ...
            const currentTNode = getCurrentTNodePlaceholderOk(),
              ...
              tNode = (tView.data[index] = (function createTNode(
                tView,
                tParent,
                type,
                index,
      ...
      function renderView(tView, lView, context2) {
        ...
        try {
          ...
          throw (
            (tView.firstCreatePass &&
              ((tView.incompleteFirstPass = !0), (tView.firstCreatePass = !1)),
            error)
          );
        } finally {
          (lView[2] &= -5), leaveView();
      ...
      function refreshView(tView, lView, templateFn, context2) {
        ...
        if (128 != (128 & flags)) {
          ...
          try {
            ...
            const viewQuery = tView.viewQuery;
            if (
              (null !== viewQuery && executeViewQueryFn(2, viewQuery, context2),
              hooksInitPhaseCompleted)
            ) {
            ...
            !0 === tView.firstUpdatePass && (tView.firstUpdatePass = !1),
              (lView[2] &= -41),
              512 & lView[2] &&
                ((lView[2] &= -513), updateTransplantedViewCount(lView[3], -1));
          } finally {
            leaveView();
          }
        }
      ...
      function executeTemplate(tView, lView, templateFn, rf, context2) {
        ...
        try {
          setSelectedIndex(-1),
            isUpdatePhase &&
              lView.length > 22 &&
              selectIndexInternal(tView, lView, 22, !1),
          ...
          128 == (128 & tNode.flags) &&
            (function invokeDirectivesHostBindings(tView, lView, tNode) {
              const start = tNode.directiveStart,
                ...
                currentDirectiveIndex = (function getCurrentDirectiveIndex() {
      ...
      function createTView(
        ...
        const bindingStartIndex = 22 + decls,
          initialViewLength = bindingStartIndex + vars,
          blueprint = (function createViewBlueprint(
            bindingStartIndex,
            initialViewLength
          ) {
            const blueprint = [];
          ...
          consts =
            "function" == typeof constsOrFactory
              ? constsOrFactory()
              : constsOrFactory;
        return (blueprint[1] = {
          type,
      ...
      function resolveDirectives(tView, lView, tNode, localRefs) {
        ...
        if (getBindingsEnabled()) {
          const directiveDefs = (function findDirectiveDefMatches(
              tView,
              viewData,
              tNode
            ) {
      ...
      function registerHostBindingOpCodes(
        ...
        if (hostBindings) {
          ...
          (function lastSelectedElementIdx(hostBindingOpCodes) {
            ...
            return 0;
          })(hostBindingOpCodes) != elementIndx &&
            hostBindingOpCodes.push(elementIndx),
            hostBindingOpCodes.push(
              directiveIdx,
              directiveVarsIdx,
              hostBindings
            );
      ...
      function addComponentLogic(lView, hostTNode, def) {
        const native = getNativeByTNode(hostTNode, lView),
          tView = getOrCreateComponentTView(def),
      ...
      function refreshComponent(hostLView, componentHostIdx) {
        ...
        if (viewAttachedToChangeDetector(componentView)) {
          ...
          48 & componentView[2]
            ...
            : componentView[5] > 0 && refreshContainsDirtyView(componentView);
        }
      }
          ...
          for (let i = 10; i < lContainer.length; i++) {
            ...
            if (viewAttachedToChangeDetector(embeddedLView))
              if (512 & embeddedLView[2]) {
                ...
                embeddedLView[5] > 0 && refreshContainsDirtyView(embeddedLView);
          }
      ...
      function handleError(lView, error) {
        const injector = lView[9],
          errorHandler2 = injector ? injector.get(ErrorHandler, null) : null;
          ...
          if (this._appRef) this._appRef.detachView(this);
            ...
            if (isLContainer(parent)) {
              const viewRefs = parent[8],
                index = viewRefs ? viewRefs.indexOf(this) : -1;
              index > -1 &&
                (detachView(parent, index), removeFromArray(viewRefs, index));
            }
            this._attachedToViewContainer = !1;
          }
      ...
      function toRefArray(map2) {
        ...
        for (let nonMinified in map2)
          map2.hasOwnProperty(nonMinified) &&
            array.push({
      ...
      class ChainedInjector {
        ...
        get(token, notFoundValue, flags) {
          ...
          return value !== NOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR ||
            ...
            ? value
            : this.parentInjector.get(token, notFoundValue, flags);
        }
      }
      class ComponentFactory extends ComponentFactory$1 {
        ...
        create(
          ...
          let realEnvironmentInjector =
            (environmentInjector =
              environmentInjector || this.ngModule) instanceof
            EnvironmentInjector
              ? environmentInjector
          ...
          const sanitizer = rootViewInjector.get(Sanitizer, null),
            ...
            rootFlags = this.componentDef.onPush ? 288 : 272,
          ...
          enterView(rootLView);
          try {
            const componentView = (function createRootComponentView(
              rNode,
              def,
              rootView,
              rendererFactory,
              ...
              rootView[22] = rNode;
              const tNode = getOrCreateTNode(tView, 22, 2, "#host", null),
            ...
            if (
              ((tElementNode = getTNode(rootTView, 22)),
            ...
            (component = (function createRootComponent(
              componentView,
              componentDef,
              rootLView,
              hostFeatures
              ...
              const tView = rootLView[1],
                component = (function instantiateRootComponent(
                  tView,
                  lView,
                  def
                ) {
              ...
              if (
                ((componentView[8] = rootLView[8] = component),
                null !== hostFeatures)
              )
            ...
            })(componentView, this.componentDef, rootLView, [
      ...
      class ComponentRef extends class ComponentRef$1 {} {
        ...
        setInput(name, value) {
          ...
          if (null !== inputData && (dataValue = inputData[name])) {
            ...
            setInputsForProperty(lView[1], lView, dataValue, name, value),
      ...
      function core_getSymbolIterator() {
        if (!_symbolIterator) {
          ...
          if (Symbol2 && Symbol2.iterator) _symbolIterator = Symbol2.iterator;
          else {
      ...
      function isListLikeIterable(obj) {
        return (
          !!isJsObject(obj) &&
          (Array.isArray(obj) ||
            (!(obj instanceof Map) && core_getSymbolIterator() in obj))
        );
      }
                ...
                return (
                  null !== tView.queries &&
                    ...
                    (embeddedTView.queries =
                      tView.queries.embeddedTView(tNode))),
                  tNode
                );
              })(
                adjustedIndex,
          ...
          bindingUpdated(lView, nextBindingIndex(), value) &&
            (function elementPropertyInternal(
              ...
              (dataValue = inputData[propName])
                ...
                : 3 & tNode.type &&
                  ((propName = (function mapPropName(name) {
                    return "class" === name
                      ? "className"
                      : "for" === name
                      ? "htmlFor"
                  ...
                  (value =
                    null != sanitizer
                      ? sanitizer(value, tNode.value || "", propName)
                      : value),
      ...
      function ɵɵelementEnd() {
        ...
        isCurrentTNodeParent()
          ...
          : ((currentTNode = currentTNode.parent),
            setCurrentTNode(currentTNode, !1));
        ...
        return (
          tView.firstCreatePass &&
            ...
            isContentQueryHost(currentTNode) &&
        ...
        return (
          (function listenerInternal(
            ...
            const isTNodeDirectiveHost = isDirectiveHost(tNode),
              tCleanup =
                tView.firstCreatePass && getOrCreateTViewCleanup(tView),
              context2 = lView[8],
              lCleanup = getOrCreateLViewCleanup(lView);
            ...
            if (3 & tNode.type || eventTargetResolver) {
              ...
              if (
                (!eventTargetResolver &&
                  ...
                  (existingListener = (function findExistingListener(
                    tView,
                    lView,
                    eventName,
                    tNodeIdx
            ...
            if (
              ...
              if (propsLength)
                for (let i = 0; i < propsLength; i += 2) {
                  const subscription =
                      lView[props[i]][props[i + 1]].subscribe(listenerFn),
                    idx = lCleanup.length;
      ...
      function wrapListener(
        ...
        return function wrapListenerIn_markDirtyAndPreventDefault(e) {
          ...
          for (; nextListenerFn; )
            (result =
              executeListenerWithErrorHandling(lView, 0, nextListenerFn, e) &&
              result),
      ...
      function ɵɵnextContext(level = 1) {
        return (function nextContextImpl(level) {
          return (instructionState.lFrame.contextLView = (function walkUpViews(
            nestingLevel,
            currentView
          ) {
            for (; nestingLevel > 0; )
      ...
      function ɵɵclassProp(className, value) {
        return (
          (function checkStylingProperty(prop, value, suffix, isClassBased) {
            const lView = getLView(),
              tView = getTView(),
              bindingIndex = (function incrementBindingIndex(count) {
                const lFrame = instructionState.lFrame,
                  index = lFrame.bindingIndex;
                return (
                  (lFrame.bindingIndex = lFrame.bindingIndex + count), index
                );
              })(2);
            tView.firstUpdatePass &&
              (function stylingFirstUpdatePass(
                ...
                if (null === tData[bindingIndex + 1]) {
                  const tNode = tData[getSelectedIndex()],
                    isHostBindings = (function isInHostBindings(
                      tView,
                      bindingIndex
                    ) {
                  ...
                  (function hasStylingInputShadow(tNode, isClassBased) {
                    ...
                    !isHostBindings &&
                    (tStylingKey = !1),
                    (tStylingKey = (function wrapInStaticStylingKey(
                      tData,
                      tNode,
                      stylingKey,
                      isClassBased
                    ) {
                      const hostDirectiveDef = (function getCurrentDirectiveDef(
                        tData
                      ) {
                      ...
                      if (null === hostDirectiveDef)
                        ...
                        if (
                          ...
                          if (
                            ...
                            residual = (function collectResidual(
                              tData,
                              tNode,
                              isClassBased
                            ) {
                      ...
                      if (isHostBinding)
                        if (0 !== tmplTail) {
                          ...
                          (tData[index + 1] = toTStylingRange(
                            ...
                            (tData[tmplHead + 1] =
                              (function setTStylingRangePrev(
                                tStylingRange,
                                previous
                              ) {
                                return (
                                  (131071 & tStylingRange) | (previous << 17)
                                );
              ...
              })(tView, prop, bindingIndex, isClassBased),
              value !== NO_CHANGE &&
                ...
                (function updateStyling(
                  ...
                  lView[11],
                  prop,
                  (lView[bindingIndex + 1] = (function normalizeSuffix(
                    value,
                    suffix
                  ) {
                    return (
      ...
      function ɵɵtext(index, value = "") {
        const lView = getLView(),
          ...
          tNode = tView.firstCreatePass
            ...
            : tView.data[adjustedIndex],
          textNative = (lView[adjustedIndex] = (function createTextNode(
            renderer,
            value
          ) {
      ...
      function ɵɵtextInterpolate1(prefix, v0, suffix) {
        const lView = getLView(),
          interpolated = (function interpolation1(lView, prefix, v0, suffix) {
      ...
      function resolveProvider(
        ...
        if (((provider = resolveForwardRef(provider)), Array.isArray(provider)))
          ...
          const tNode = getCurrentTNode(),
            beginIndex = 1048575 & tNode.providerIndexes,
            endIndex = tNode.directiveStart,
            cptViewProvidersCount = tNode.providerIndexes >> 20;
          if (isTypeProvider(provider) || !provider.multi) {
            ...
            -1 === existingFactoryIndex
              ? (diPublicInInjector(
                ...
                tNode.directiveEnd++,
                isViewProvider && (tNode.providerIndexes += 1048576),
            ...
            if (
              ...
              const factory = (function multiFactory(
                factoryFn,
                index,
                isViewProvider,
                isComponent,
      ...
      function registerDestroyHooksIfSupported(
        ...
        const providerIsTypeProvider = isTypeProvider(provider),
          providerIsClassProvider = (function isClassProvider(value) {
            return !!value.useClass;
          })(provider);
        if (providerIsTypeProvider || providerIsClassProvider) {
          const ngOnDestroy = (
            providerIsClassProvider
      ...
      function multiFactoryAdd(multiFactory2, factory, isComponentProvider) {
        return (
          isComponentProvider && multiFactory2.componentProviders++,
          multiFactory2.multi.push(factory) - 1
        );
      }
      ...
      const EventEmitter = class EventEmitter_ extends Subject {
        ...
        subscribe(observerOrNext, error, complete) {
          ...
          this.__isAsync &&
            ...
            nextFn && (nextFn = _wrapInTimeout(nextFn)),
          ...
          return (
            observerOrNext instanceof Subscription && observerOrNext.add(sink),
            sink
          );
        }
      };
      ...
      let TemplateRef = (() => {
        class TemplateRef2 {}
        return (
          (TemplateRef2.__NG_ELEMENT_ID__ = injectTemplateRef), TemplateRef2
        );
      })();
      ...
      const VE_ViewContainerRef = ViewContainerRef,
        R3ViewContainerRef = class extends VE_ViewContainerRef {
          ...
          get parentInjector() {
            ...
            if (hasParentInjector(parentLocation)) {
              ...
              return new NodeInjector(
                parentView[1].data[injectorIndex + 8],
                parentView
              );
            }
          ...
          createComponent(
            ...
            let index;
            if (isComponentFactory) index = indexOrOptions;
            else {
              ...
              (index = options.index),
                ...
                (environmentInjector =
                  options.environmentInjector || options.ngModuleRef);
            }
            const componentFactory = isComponentFactory
                ? componentFactoryOrType
                : new ComponentFactory(getComponentDef(componentFactoryOrType)),
              contextInjector = injector || this.parentInjector;
            if (!environmentInjector && null == componentFactory.ngModule) {
              const result = (
                isComponentFactory ? contextInjector : this.parentInjector
              ).get(EnvironmentInjector, null);
          ...
          remove(index) {
            ...
            detachedView &&
              (removeFromArray(
                getOrCreateViewRefs(this._lContainer),
                adjustedIdx
              ),
      ...
      let ApplicationInitStatus = (() => {
        ...
        return (
          (ApplicationInitStatus2.ɵfac = function (t) {
      ...
      const PLATFORM_INITIALIZER = new InjectionToken("Platform Initializer"),
        core_PLATFORM_ID = new InjectionToken("Platform ID", {
          providedIn: "platform",
          factory: () => "unknown",
        }),
      ...
      class core_NgZone {
        constructor({
          ...
          shouldCoalesceEventChangeDetection = !1,
          shouldCoalesceRunChangeDetection = !1,
        }) {
          if (
          ...
          if (
            ...
            self2._inner = self2._inner.fork(
          ...
          Zone.TaskTrackingZoneSpec &&
            ...
            (self2.shouldCoalesceEventChangeDetection =
              !shouldCoalesceRunChangeDetection &&
              shouldCoalesceEventChangeDetection),
            (self2.shouldCoalesceRunChangeDetection =
              shouldCoalesceRunChangeDetection),
            ...
            (function forkInnerZoneWithAngularBehavior(zone) {
              const delayChangeDetectionForEventsDelegate = () => {
                !(function delayChangeDetectionForEvents(zone) {
                  zone.isCheckStableRunning ||
                    -1 !== zone.lastRequestAnimationFrameId ||
                    ((zone.lastRequestAnimationFrameId =
                      zone.nativeRequestAnimationFrame.call(_global, () => {
                          ...
                          (zone.fakeTopEventTask = Zone.root.scheduleEventTask(
                            ...
                            () => {
                              (zone.lastRequestAnimationFrameId = -1),
                                ...
                                (zone.isCheckStableRunning = !0),
                                checkStable(zone),
                                (zone.isCheckStableRunning = !1);
                            },
                            void 0,
                            () => {},
                            () => {}
      ...
      let _testabilityGetter,
        Testability = (() => {
          ...
          return (
            (Testability2.ɵfac = function (t) {
              return new (t || Testability2)(
                core_inject(core_NgZone),
                core_inject(TestabilityRegistry),
        ...
        TestabilityRegistry = (() => {
          class TestabilityRegistry2 {
            ...
            findTestabilityInTree(elem, findInAncestors = !0) {
              return (
                _testabilityGetter?.findTestabilityInTree(
                  this,
                  elem,
                  findInAncestors
                ) ?? null
      ...
      function createPlatformFactory(
        ...
        return (extraProviders = []) => {
          ...
          if (
            !platform ||
            platform.injector.get(ALLOW_MULTIPLE_PLATFORMS, !1)
          ) {
            ...
            parentPlatformFactory
              ...
              : (function createPlatform(injector) {
                  if (
                    _platformInjector &&
                    !_platformInjector.get(ALLOW_MULTIPLE_PLATFORMS, !1)
                  )
                    throw new RuntimeError(400, !1);
      ...
      let PlatformRef = (() => {
        class PlatformRef2 {
            ...
            const ngZone = (function getNgZone(ngZoneToUse, options) {
                ...
                return (
                  (ngZone =
                    "noop" === ngZoneToUse
                      ? new NoopNgZone()
                      : ("zone.js" === ngZoneToUse ? void 0 : ngZoneToUse) ||
                        new core_NgZone(options)),
                  ngZone
                );
              })(
                options?.ngZone,
                (function getNgZoneOptions(options) {
                  return {
                    ...
                    shouldCoalesceRunChangeDetection:
                      !(!options || !options.ngZoneRunCoalescing) || !1,
                  };
                })(options)
              ),
              providers = [
                        ...
                        (function setLocaleId(localeId) {
                          assertDefined(
                            ...
                            "string" == typeof localeId &&
                              (LOCALE_ID$1 = localeId
                                .toLowerCase()
                                .replace(/_/g, "-"));
                        })(
                          moduleRef.injector.get(LOCALE_ID, "en-US") || "en-US"
                        ),
          ...
          bootstrapModule(moduleType, compilerOptions = []) {
            ...
            return (function compileNgModuleFactory(
              injector,
              options,
              moduleType
            ) {
      ...
      let core_ApplicationRef = (() => {
        class ApplicationRef2 {
          constructor(_zone, _injector, _exceptionHandler) {
            ...
            this.isStable = (function merge(...args) {
              const scheduler = popScheduler(args),
                concurrent = (function popNumber(args, defaultValue) {
                  return "number" == typeof last(args)
                    ? args.pop()
                    : defaultValue;
                })(args, 1 / 0),
                sources = args;
                ...
                (!isComponentFactory &&
                  (function isStandalone(type) {
                    const def =
                      ...
                      getDirectiveDef(type) ||
                      getPipeDef$1(type);
                    return null !== def && def.standalone;
                  })(componentOrFactory),
                new RuntimeError(405, !1))
              );
            let componentFactory;
            (componentFactory = isComponentFactory
              ? componentOrFactory
              : this._injector
                  .get(ComponentFactoryResolver$1)
          ...
          onDestroy(callback) {
            return (
              this._destroyListeners.push(callback),
              () => remove(this._destroyListeners, callback)
            );
          }
          destroy() {
        ...
        return (
          (ApplicationRef2.ɵfac = function (t) {
      ...
      class DefaultKeyValueDiffer {
        ...
        diff(map2) {
          if (map2) {
            if (!(map2 instanceof Map || isJsObject(map2)))
              throw new RuntimeError(900, !1);
          } else map2 = new Map();
      ...
      let ApplicationModule = (() => {
        ...
        return (
          (ApplicationModule2.ɵfac = function (t) {
            return new (t || ApplicationModule2)(
              core_inject(core_ApplicationRef)
            );
          }),
      ...
      let NgClass = (() => {
        class NgClass2 {
          ...
          set ngClass(value) {
            this._removeClasses(this._rawClass),
              ...
              this._rawClass &&
                (isListLikeIterable(this._rawClass)
        ...
        return (
          (NgClass2.ɵfac = function (t) {
            return new (t || NgClass2)(
              ɵɵdirectiveInject(IterableDiffers),
              ɵɵdirectiveInject(KeyValueDiffers),
              ɵɵdirectiveInject(core_ElementRef),
              ɵɵdirectiveInject(core_Renderer2)
            );
          }),
      ...
      let NgForOf = (() => {
        ...
        return (
          (NgForOf2.ɵfac = function (t) {
            return new (t || NgForOf2)(
        ...
        getBaseHref(doc) {
          const href = (function getBaseElementHref() {
            return (
              ...
              baseElement ? baseElement.getAttribute("href") : null
            );
          })();
          return null == href
            ? null
        ...
        SERVER_TRANSITION_PROVIDERS = [
          {
            ...
            useFactory: function appInitializerFactory(
              transitionId,
              document2,
              injector
            ) {
              return () => {
                injector.get(ApplicationInitStatus).donePromise.then(() => {
                  const dom = getDOM(),
                    styles = document2.querySelectorAll(
      ...
      let EventManager = (() => {
          ...
          _findPluginFor(eventName) {
            ...
            for (let i = 0; i < plugins.length; i++) {
              ...
              if (plugin2.supports(eventName))
                return this._eventNameToPlugin.set(eventName, plugin2), plugin2;
            }
            throw new Error(
        ...
        return (
          (EventManager2.ɵfac = function (t) {
            return new (t || EventManager2)(
              core_inject(EVENT_MANAGER_PLUGINS),
              core_inject(core_NgZone)
            );
          }),
        ...
        DomSharedStylesHost = (() => {
          class DomSharedStylesHost2 extends SharedStylesHost {
            ...
            removeHost(hostNode) {
              ...
              styleNodes && styleNodes.forEach(removeStyle),
            ...
            ngOnDestroy() {
              this._hostNodes.forEach((styleNodes) =>
                styleNodes.forEach(removeStyle)
              );
            }
          }
          return (
            (DomSharedStylesHost2.ɵfac = function (t) {
              return new (t || DomSharedStylesHost2)(
                core_inject(common_DOCUMENT)
              );
            }),
      ...
      let DomRendererFactory2 = (() => {
        ...
        return (
          (DomRendererFactory22.ɵfac = function (t) {
            return new (t || DomRendererFactory22)(
              core_inject(EventManager),
              core_inject(DomSharedStylesHost),
      ...
      class DefaultDomRenderer2 {
        ...
        appendChild(parent, newChild) {
          (platform_browser_isTemplateNode(parent)
            ? parent.content
            : parent
        ...
        removeStyle(el, style, flags) {
          flags & RendererStyleFlags2.DashCase
      ...
      class EmulatedEncapsulationDomRenderer2 extends DefaultDomRenderer2 {
        constructor(eventManager, sharedStylesHost, component, appId) {
          ...
          sharedStylesHost.addStyles(styles),
            (this.contentAttr = (function shimContentAttribute(
              componentShortId
            ) {
              return "_ngcontent-%COMP%".replace(
                COMPONENT_REGEX,
                componentShortId
              );
            })(appId + "-" + component.id)),
            (this.hostAttr = (function shimHostAttribute(componentShortId) {
        ...
        class KeyEventsPlugin2 extends EventManagerPlugin {
          ...
          addEventListener(element, eventName, handler) {
            const parsedEvent = KeyEventsPlugin2.parseEventName(eventName),
              outsideHandler = KeyEventsPlugin2.eventCallback(
                parsedEvent.fullKey,
                handler,
          ...
          static parseEventName(eventName) {
            ...
            let fullKey = "",
              codeIX = parts.indexOf("code");
            if (
              (codeIX > -1 && (parts.splice(codeIX, 1), (fullKey = "code.")),
          ...
          static matchEventFullKeyCode(event, fullKeyCode) {
            let keycode = _keyMap[event.key] || event.key,
              key = "";
            return (
              fullKeyCode.indexOf("code.") > -1 &&
                ((keycode = event.code), (key = "code.")),
              !(null == keycode || !keycode) &&
          ...
          static eventCallback(fullKey, handler, zone) {
            return (event) => {
              KeyEventsPlugin2.matchEventFullKeyCode(event, fullKey) &&
      ...
      const platformBrowser = createPlatformFactory(platformCore, "browser", [
        ...
        BROWSER_MODULE_PROVIDERS_MARKER = new InjectionToken(""),
      ...
      let BaseControlValueAccessor = (() => {
          ...
          return (
            (BaseControlValueAccessor2.ɵfac = function (t) {
              return new (t || BaseControlValueAccessor2)(
                ɵɵdirectiveInject(core_Renderer2),
                ɵɵdirectiveInject(core_ElementRef)
              );
            }),
          ...
          return (
            (BuiltInControlValueAccessor2.ɵfac = (function () {
              ...
              return function (t) {
                    ...
                    (function ɵɵgetInheritedFactory(type) {
                      return noSideEffects(() => {
                        ...
                        for (; parent && parent !== objectPrototype; ) {
                          const factory =
                            parent[NG_FACTORY_DEF] || getFactoryOf(parent);
                ...
                )(t || BuiltInControlValueAccessor2);
              };
            })()),
      ...
      let DefaultValueAccessor = (() => {
        ...
        return (
          (DefaultValueAccessor2.ɵfac = function (t) {
            return new (t || DefaultValueAccessor2)(
              ɵɵdirectiveInject(core_Renderer2),
              ɵɵdirectiveInject(core_ElementRef),
          ...
          (DefaultValueAccessor2.ɵdir = ɵɵdefineDirective({
            ...
            hostBindings: function (rf, ctx) {
              1 & rf &&
                ɵɵlistener("input", function ($event) {
          ...
          ? (function composeAsync(validators) {
              ...
              return 0 == presentValidators.length
                ...
                : function (control) {
                    ...
                    ).pipe(map(mergeErrors));
                  };
            })(normalizeValidators(validators))
          : null;
      }
      function mergeValidators(controlValidators, dirValidator) {
        return null === controlValidators
          ? [dirValidator]
      ...
      class NgControl extends class AbstractControlDirective {
        ...
        _setValidators(validators) {
          (this._rawValidators = validators || []),
            (this._composedValidatorFn = composeValidators(
              this._rawValidators
            ));
        }
      ...
      let NgControlStatus = (() => {
        ...
        return (
          (NgControlStatus2.ɵfac = function (t) {
      ...
      function setUpControl(control, dir) {
        (function setUpValidators(control, dir) {
          ...
          null !== dir.asyncValidator
            ...
            : "function" == typeof asyncValidators &&
          ...
          control.disabled && dir.valueAccessor.setDisabledState?.(!0),
      ...
      let FormControlDirective = (() => {
                ...
                (this.valueAccessor = (function selectValueAccessor(
                  ...
                  return (
                    ...
                    valueAccessors.forEach((v) => {
                      v.constructor === DefaultValueAccessor
                        ? (defaultAccessor = v)
        ...
        ɵInternalFormsSharedModule = (() => {
          ...
          return (
            (ɵInternalFormsSharedModule2.ɵfac = function (t) {
      ...
      function TodoListComponent_main_0_Template(rf, ctx) {
        if (1 & rf) {
          ...
          ɵɵelementStart(0, "main", 1)(1, "div", 2)(2, "input", 3),
            ...
            ɵɵtemplate(
              6,
              TodoListComponent_main_0_app_todo_item_6_Template,
              1,
              2,
              "app-todo-item",
              6
        ...
        return (
          ...
          (TodoListComponent2.ɵcmp = ɵɵdefineComponent({
            ...
            consts: [
              ...
              [3, "todo", "index", "deleteEvent"],
            ],
            template: function (rf, ctx) {
              1 & rf &&
                ɵɵtemplate(
                  0,
                  TodoListComponent_main_0_Template,
                  7,
                  3,
                  "main",
                  0
