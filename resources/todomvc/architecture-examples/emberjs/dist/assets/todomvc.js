...
try {
  ...
  console.log(document.querySelector('meta[name="' + metaName + '"]').content)
...
if (!runningTests) {
  require("todomvc/app")["default"].create({"name":"todomvc","version":"0.0.0+24b094d1"});
}
