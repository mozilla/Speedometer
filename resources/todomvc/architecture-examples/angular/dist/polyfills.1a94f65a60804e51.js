...
(self.webpackChunkangular = self.webpackChunkangular || []).push([ [ 429 ], {
    583: () => {
        ...
        const zoneSymbol = Zone.__symbol__, isWindowExists = typeof window < "u", internalWindow = isWindowExists ? window : void 0, _global = isWindowExists && internalWindow || "object" == typeof self && self || global, REMOVE_ATTRIBUTE = "removeAttribute";
        ...
        const isWebWorker = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope, isNode = !("nw" in _global) && typeof _global.process < "u" && "[object process]" === {}.toString.call(_global.process), isBrowser = !isNode && !isWebWorker && !(!isWindowExists || !internalWindow.HTMLElement), isMix = typeof _global.process < "u" && "[object process]" === {}.toString.call(_global.process) && !isWebWorker && !(!isWindowExists || !internalWindow.HTMLElement), zoneSymbolEventNames$1 = {}, wrapFn = function(event) {
            ...
            let result;
            return isBrowser && target === internalWindow && "error" === event.type ? (result = listener && listener.call(this, event.message, event.filename, event.lineno, event.colno, event.error), 
            !0 === result && event.preventDefault()) : (result = listener && listener.apply(this, arguments), 
            null != result && !result && event.preventDefault()), result;
        };
            ...
            function patchEventTargetMethods(obj, patchOptions2) {
                ...
                const customSchedule = useGlobalCallback ? function(task) {
                    ...
                    return function() {
                        ...
                        const passive = passiveSupported && !!passiveEvents && -1 !== passiveEvents.indexOf(eventName), options = function buildEventListenerOptions(options, passive) {
            ...
            !function patchXHR(window2) {
                ...
                const openNative = patchMethod(XMLHttpRequestPrototype, "open", () => function(self2, args) {
                    ...
                    if (!0 === Zone2.current[fetchTaskScheduling] || self2[XHR_SYNC]) return sendNative.apply(self2, args);
                    {
                        ...
                        self2 && !0 === self2[XHR_ERROR_BEFORE_SCHEDULED] && !options.aborted && task.state === SCHEDULED && task.invoke();
                    }
    ...
    __webpack_require__(__webpack_require__.s = 583);
} ]);