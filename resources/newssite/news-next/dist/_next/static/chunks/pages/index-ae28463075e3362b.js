/*! For license information please see index-ae28463075e3362b.js.LICENSE.txt */
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([ [ 405 ], {
    ...
    3740: function(e, t, i) {
        ...
        const v = (0, s.forwardRef)(((e, t) => {
            ...
            let {src: i, sizes: a, unoptimized: h = !1, priority: b = !1, loading: q, className: f, quality: w, width: _, height: y, fill: j, style: x, onLoad: P, onLoadingComplete: N, placeholder: E = "empty", blurDataURL: S, fetchPriority: k, layout: A, objectFit: C, objectPosition: M, lazyBoundary: I, lazyRoot: T, ...L} = e;
    ...
    9687: function(e, t, i) {
        ...
        function h(e, t, i, s) {
            void 0 === s && (s = {});
            let {window: l = document.defaultView, v5Compat: c = !1} = s, p = l.history, h = a.Pop, g = null, v = b();
            function b() {
                return (p.state || {
                    idx: null
                }).idx;
            ...
            function f(e) {
                let t = "null" !== l.location.origin ? l.location.origin : l.location.href, i = "string" == typeof e ? e : d(e);
                return u(t, "No window.location.(origin|href) available to create URL for href: " + i), 
                new URL(i, t);
            }
            null == v && (v = 0, p.replaceState(n({}, p.state, {
                idx: v
            }), ""));
            let w = {
                get action() {
                ...
                listen(e) {
                    ...
                    return l.addEventListener(r, q), g = e, () => {
                        l.removeEventListener(r, q), g = null;
                    };
                },
                createHref(e) {
                    return t(l, e);
                ...
                push: function(e, t) {
                    h = a.Push;
                    let s = m(w.location, e, t);
                    i && i(s, e), v = b() + 1;
                    let n = o(s, v), r = w.createHref(s);
                    try {
                        p.pushState(n, "", r);
                    } catch (e) {
                        l.location.assign(r);
                ...
                replace: function(e, t) {
                    ...
                    let s = m(w.location, e, t);
                    i && i(s, e), v = b();
                    let l = o(s, v), n = w.createHref(s);
                    p.replaceState(l, "", n), c && g && g({
                        action: h,
                        location: w.location,
                        delta: 0
                    });
        ...
        function v(e, t, i) {
            void 0 === i && (i = "/");
            let a = A(("string" == typeof t ? p(t) : t).pathname || "/", i);
            ...
            let l = null;
            for (let e = 0; null == l && e < s.length; ++e) l = E(s[e], k(a));
            return l;
        }
        function b(e, t, i, a) {
            ...
            let s = (e, s, l) => {
                ...
                n.relativePath.startsWith("/") && (u(n.relativePath.startsWith(a), 'Absolute route path "' + n.relativePath + '" nested under path "' + a + '" is not valid. An absolute child route path must start with the combined path of all its parent routes.'), 
                n.relativePath = n.relativePath.slice(a.length));
                let r = T([ a, n.relativePath ]), c = i.concat(n);
                e.children && e.children.length > 0 && (u(!0 !== e.index, 'Index routes must not have child routes. Please remove all child routes from route path "' + r + '".'), 
                b(e.children, t, c, r)), (null != e.path || e.index) && t.push({
                    path: r,
                    score: N(r, e.index),
                    routesMeta: c
                });
            ...
            return e.forEach(((e, t) => {
                var i;
                if ("" !== e.path && null != (i = e.path) && i.includes("?")) for (let i of q(e.path)) s(e, t, i); else s(e, t);
            })), t;
        }
        function q(e) {
            let t = e.split("/");
        ...
        const f = /^:\w+$/, w = 3, _ = 2, y = 1, j = 10, x = -2, P = e => "*" === e;
        function N(e, t) {
            let i = e.split("/"), a = i.length;
            return i.some(P) && (a += x), t && (a += _), i.filter((e => !P(e))).reduce(((e, t) => e + (f.test(t) ? w : "" === t ? y : j)), a);
        }
        function E(e, t) {
            let {routesMeta: i} = e, a = {}, s = "/", l = [];
            for (let e = 0; e < i.length; ++e) {
                let n = i[e], r = e === i.length - 1, u = "/" === s ? t : t.slice(s.length) || "/", c = S({
                    path: n.relativePath,
                ...
                l.push({
                    params: a,
                    pathname: T([ s, c.pathname ]),
                    pathnameBase: L(T([ s, c.pathnameBase ])),
                    route: o
                }), "/" !== c.pathnameBase && (s = T([ s, c.pathnameBase ]));
            }
            return l;
        }
        function S(e, t) {
                ...
                params: a.reduce(((e, t, i) => {
                    ...
                    return e[t] = function(e, t) {
                        try {
                            ...
                            return c(!1, 'The value for the URL param "' + t + '" will not be decoded because the string "' + e + '" is a malformed URL segment. This is probably due to a bad percent encoding (' + i + ")."), 
                            e;
                        }
                    }(r[i] || "", t), e;
                }), {}),
        ...
        function k(e) {
            try {
                ...
                return c(!1, 'The URL path "' + e + '" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent encoding (' + t + ")."), 
                e;
            }
        }
        function A(e, t) {
        ...
        function I(e, t, i, a) {
            let s;
            void 0 === a && (a = !1), "string" == typeof e ? s = p(e) : (s = n({}, e), u(!s.pathname || !s.pathname.includes("?"), C("?", "pathname", "search", s)), 
            u(!s.pathname || !s.pathname.includes("#"), C("#", "pathname", "hash", s)), u(!s.search || !s.search.includes("#"), C("#", "search", "hash", s)));
            let l, r = "" === e || "" === s.pathname, c = r ? "/" : s.pathname;
            if (a || null == c) l = i; else {
                let e = t.length - 1;
                if (c.startsWith("..")) {
                    let t = c.split("/");
                    for (;".." === t[0]; ) t.shift(), e -= 1;
            ...
            let o = function(e, t) {
                void 0 === t && (t = "/");
                let {pathname: i, search: a = "", hash: s = ""} = "string" == typeof e ? p(e) : e, l = i ? i.startsWith("/") ? i : function(e, t) {
            ...
            }(s, l), m = c && "/" !== c && c.endsWith("/"), d = (r || "." === c) && i.endsWith("/");
            return o.pathname.endsWith("/") || !m && !d || (o.pathname += "/"), o;
        }
        const T = e => e.join("/").replace(/\/\/+/g, "/"), L = e => e.replace(/\/+$/, "").replace(/^\/*/, "/"), U = e => e && "?" !== e ? e.startsWith("?") ? e : "?" + e : "", V = e => e && "#" !== e ? e.startsWith("#") ? e : "#" + e : "";
        Error;
        function R(e) {
            return null != e && "number" == typeof e.status && "string" == typeof e.statusText && "boolean" == typeof e.internal && "data" in e;
        }
        const F = [ "post", "put", "patch", "delete" ], O = (new Set(F), [ "get", ...F ]);
        new Set(O), new Set([ 301, 302, 303, 307, 308 ]), new Set([ 307, 308 ]), "undefined" != typeof window && void 0 !== window.document && window.document.createElement;
        Symbol("deferred");
        function D() {
        ...
        function K() {
            return J() || u(!1), l.useContext(W).location;
        }
        function $(e) {
        ...
        function Z() {
            ...
            return e ? function() {
                let {router: e} = re(le.UseNavigateStable), t = ce(ne.UseNavigateStable), i = l.useRef(!1);
                return $((() => {
                    i.current = !0;
                })), l.useCallback((function(a, s) {
                    void 0 === s && (s = {}), i.current && ("number" == typeof a ? e.navigate(a) : e.navigate(a, D({
                        fromRouteId: t
                    }, s)));
                }), [ e, t ]);
            }() : function() {
                J() || u(!1);
                let {basename: e, navigator: t} = l.useContext(H), {matches: i} = l.useContext(Q), {pathname: a} = K(), s = JSON.stringify(M(i).map((e => e.pathnameBase))), n = l.useRef(!1);
                return $((() => {
                    n.current = !0;
                })), l.useCallback((function(i, l) {
                    if (void 0 === l && (l = {}), !n.current) return;
                    if ("number" == typeof i) return void t.go(i);
                    let r = I(i, JSON.parse(s), a, "path" === l.relative);
                    "/" !== e && (r.pathname = "/" === r.pathname ? e : T([ e, r.pathname ])), (l.replace ? t.replace : t.push)(r, l.state, l);
                }), [ e, t, s, a ]);
            }();
        }
        function Y(e, t) {
            let {relative: i} = void 0 === t ? {} : t, {matches: a} = l.useContext(Q), {pathname: s} = K(), n = JSON.stringify(M(a).map((e => e.pathnameBase)));
            return l.useMemo((() => I(e, JSON.parse(n), s, "path" === i)), [ e, n, s, i ]);
        }
        function X(e, t, i) {
            J() || u(!1);
            let {navigator: s} = l.useContext(H), {matches: n} = l.useContext(Q), r = n[n.length - 1], c = r ? r.params : {}, o = (r && r.pathname, 
            r ? r.pathnameBase : "/");
            r && r.route;
            let m, d = K();
            if (t) {
                ...
                "/" === o || (null == (h = e.pathname) ? void 0 : h.startsWith(o)) || u(!1), m = e;
            } else m = d;
            let g = m.pathname || "/", b = v(e, {
                pathname: "/" === o ? g : g.slice(o.length) || "/"
            });
            let q = se(b && b.map((e => Object.assign({}, e, {
                params: Object.assign({}, c, e.params),
                pathname: T([ o, s.encodeLocation ? s.encodeLocation(e.pathname).pathname : e.pathname ]),
                pathnameBase: "/" === e.pathnameBase ? o : T([ o, s.encodeLocation ? s.encodeLocation(e.pathnameBase).pathname : e.pathnameBase ])
            }))), n, i);
            return t && q ? l.createElement(W.Provider, {
                value: {
                    location: D({
                        pathname: "/",
                        search: "",
        ...
        function ee() {
            let e = function() {
                var e;
                let t = l.useContext(G), i = ue(ne.UseRouteError), a = ce(ne.UseRouteError);
                if (t) return t;
                return null == (e = i.errors) ? void 0 : e[a];
            }(), t = R(e) ? e.status + " " + e.statusText : e instanceof Error ? e.message : JSON.stringify(e), i = e instanceof Error ? e.stack : null, a = "rgba(200,200,200, 0.5)", s = {
                padding: "0.5rem",
                backgroundColor: a
            };
            ...
            }, t), i ? l.createElement("pre", {
                style: s
            }, i) : null, null);
        }
        const te = l.createElement(ee, null);
        class ie extends l.Component {
            ...
            render() {
                return this.state.error ? l.createElement(Q.Provider, {
        ...
        function ae(e) {
            let {routeContext: t, match: i, children: a} = e, s = l.useContext(B);
        ...
        function se(e, t, i) {
            ...
            let n = e, r = null == (a = i) ? void 0 : a.errors;
            if (null != r) {
                let e = n.findIndex((e => e.route.id && (null == r ? void 0 : r[e.route.id])));
                e >= 0 || u(!1), n = n.slice(0, Math.min(n.length, e + 1));
            }
            return n.reduceRight(((e, a, s) => {
                let u = a.route.id ? null == r ? void 0 : r[a.route.id] : null, c = null;
                i && (c = a.route.errorElement || te);
                let o = t.concat(n.slice(0, s + 1)), m = () => {
                    let t;
                    return t = u ? c : a.route.Component ? l.createElement(a.route.Component, null) : a.route.element ? a.route.element : e, 
                    l.createElement(ae, {
                        match: a,
                        routeContext: {
                            outlet: e,
                ...
                return i && (a.route.ErrorBoundary || a.route.errorElement || 0 === s) ? l.createElement(ie, {
                    location: i.location,
        ...
        function ce(e) {
            ...
            return i.route.id || u(!1), i.route.id;
        }
        !function(e) {
        ...
        function me(e) {
            let {basename: t = "/", children: i = null, location: s, navigationType: n = a.Pop, navigator: r, static: c = !1} = e;
            J() && u(!1);
            let o = t.replace(/^\/*/, "/"), m = l.useMemo((() => ({
                basename: o,
                navigator: r,
                static: c
            })), [ o, r, c ]);
            "string" == typeof s && (s = p(s));
            let {pathname: d = "/", search: h = "", hash: g = "", state: v = null, key: b = "default"} = s, q = l.useMemo((() => {
                let e = A(d, o);
                return null == e ? null : {
                    location: {
                        pathname: e,
            ...
            return null == q ? null : l.createElement(H.Provider, {
                value: m
        ...
        function he(e, t) {
            void 0 === t && (t = []);
            let i = [];
            return l.Children.forEach(e, ((e, a) => {
                if (!l.isValidElement(e)) return;
                let s = [ ...t, a ];
                if (e.type === l.Fragment) return void i.push.apply(i, he(e.props.children, s));
                ...
                e.props.children && (n.children = he(e.props.children, s)), i.push(n);
            })), i;
        }
        function ge() {
        ...
        const be = [ "onClick", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset" ], qe = [ "aria-current", "caseSensitive", "className", "end", "style", "to", "children" ];
        function fe(e) {
            let {basename: t, children: i, window: a} = e, s = l.useRef();
            var n;
            null == s.current && (s.current = (void 0 === (n = {
                window: a,
                v5Compat: !0
            }) && (n = {}), h((function(e, t) {
                let {pathname: i = "/", search: a = "", hash: s = ""} = p(e.location.hash.substr(1));
                return m("", {
                    pathname: i,
                    search: a,
                    hash: s
                ...
                return a + "#" + ("string" == typeof t ? t : d(t));
            }), (function(e, t) {
                c("/" === e.pathname.charAt(0), "relative pathnames are not supported in hash history.push(" + JSON.stringify(t) + ")");
            }), n)));
            let r = s.current, [u, o] = l.useState({
                action: r.action,
                location: r.location
            });
            return l.useLayoutEffect((() => r.listen(o)), [ r ]), l.createElement(me, {
                basename: t,
                children: i,
                location: u.location,
        ...
        const we = "undefined" != typeof window && void 0 !== window.document && void 0 !== window.document.createElement, _e = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, ye = l.forwardRef((function(e, t) {
            let i, {onClick: a, relative: s, reloadDocument: n, replace: r, state: c, target: o, to: m, preventScrollReset: p} = e, h = ve(e, be), {basename: g} = l.useContext(H), v = !1;
            if ("string" == typeof m && _e.test(m) && (i = m, we)) try {
                let e = new URL(window.location.href), t = m.startsWith("//") ? new URL(e.protocol + m) : new URL(m), i = A(t.pathname, g);
                t.origin === e.origin && null != i ? m = i + t.search + t.hash : v = !0;
            } catch (e) {}
            let b = function(e, t) {
                let {relative: i} = void 0 === t ? {} : t;
                J() || u(!1);
                let {basename: a, navigator: s} = l.useContext(H), {hash: n, pathname: r, search: c} = Y(e, {
                    relative: i
                }), o = r;
                return "/" !== a && (o = "/" === r ? a : T([ a, r ])), s.createHref({
                    pathname: o,
                    search: c,
                    hash: n
                });
                ...
                let {target: i, replace: a, state: s, preventScrollReset: n, relative: r} = void 0 === t ? {} : t, u = Z(), c = K(), o = Y(e, {
                    relative: r
                });
            ...
            return l.createElement("a", ge({}, h, {
                href: i || b,
                onClick: v || n ? a : function(e) {
        ...
        const je = l.forwardRef((function(e, t) {
            let {"aria-current": i = "page", caseSensitive: a = !1, className: s = "", end: n = !1, style: r, to: u, children: c} = e, o = ve(e, qe), m = Y(u, {
                relative: o.relative
            }), d = K(), p = l.useContext(z), {navigator: h} = l.useContext(H), g = h.encodeLocation ? h.encodeLocation(m).pathname : m.pathname, v = d.pathname, b = p && p.navigation && p.navigation.location ? p.navigation.location.pathname : null;
            a || (v = v.toLowerCase(), b = b ? b.toLowerCase() : null, g = g.toLowerCase());
            let q, f = v === g || !n && v.startsWith(g) && "/" === v.charAt(g.length), w = null != b && (b === g || !n && b.startsWith(g) && "/" === b.charAt(g.length)), _ = f ? i : void 0;
            q = "function" == typeof s ? s({
                isActive: f,
                isPending: w
            }) : [ s, f ? "active" : null, w ? "pending" : null ].filter(Boolean).join(" ");
            let y = "function" == typeof r ? r({
                isActive: f,
                isPending: w
            }) : r;
            return l.createElement(ye, ge({}, o, {
                "aria-current": _,
                className: q,
                ref: t,
                style: y,
        ...
        var Se = "", ke = null, Ae = null, Ce = null;
        function Me() {
            Se = "", null !== ke && ke.disconnect(), null !== Ae && (window.clearTimeout(Ae), 
            Ae = null);
        }
        function Ie(e) {
        ...
        function Te() {
            var e = null;
            if ("#" === Se) e = document.body; else {
                var t = Se.replace("#", "");
                null === (e = document.getElementById(t)) && "#top" === Se && (e = document.body);
            }
            if (null !== e) {
                Ce(e);
                var i = e.getAttribute("tabindex");
                return null !== i || Ie(e) || e.setAttribute("tabindex", -1), e.focus({
                    preventScroll: !0
                }), null !== i || Ie(e) || (e.blur(), e.removeAttribute("tabindex")), Me(), !0;
            }
            return !1;
        }
        function Le(e) {
            return l.forwardRef((function(t, i) {
                var a = "";
                "string" == typeof t.to && t.to.includes("#") ? a = "#" + t.to.split("#").slice(1).join("#") : "object" == typeof t.to && "string" == typeof t.to.hash && (a = t.to.hash);
                var s = {};
                e === je && (s.isActive = function(e, t) {
                ...
                return l.createElement(e, Ee({}, s, n, {
                    onClick: function(e) {
                        var i;
                        Me(), Se = t.elementId ? "#" + t.elementId : a, t.onClick && t.onClick(e), "" === Se || e.defaultPrevented || 0 !== e.button || t.target && "_self" !== t.target || e.metaKey || e.altKey || e.ctrlKey || e.shiftKey || (Ce = t.scroll || function(e) {
                            return t.smooth ? e.scrollIntoView({
                                behavior: "smooth"
                            }) : e.scrollIntoView();
                        }, i = t.timeout, window.setTimeout((function() {
                            !1 === Te() && (null === ke && (ke = new MutationObserver(Te)), ke.observe(document, {
                                attributes: !0,
                                childList: !0,
                                subtree: !0
        ...
        var Re = i(9319), Fe = i.n(Re);
        function Oe() {
            return (0, s.jsx)("header", {
                className: Fe()["page-header"],
                children: (0, s.jsx)(ye, {
                    to: "/",
                    className: Fe()["page-header-title"],
                    children: (0, s.jsx)(Ve, {})
                })
            });
        }
        var De = i(4184), Be = i.n(De);
        const ze = {
            home: {
                name: "Front Page",
                url: "/",
        ...
        function Je(e) {
            ...
            return (0, s.jsxs)("div", {
                ...
                children: [ (0, s.jsx)("input", {
                    ...
                    className: Ge()["dropdown-label"],
                    children: [ (0, s.jsx)("span", {
                        className: Ge()["dropdown-label-text"],
                        children: We.label
                    }), (0, s.jsx)("div", {
                        className: Be()("animated-icon", "arrow-icon", "arrow", i),
                        children: (0, s.jsxs)("span", {
                            className: "animated-icon-inner",
                            title: "Arrow Icon",
                            children: [ (0, s.jsx)("span", {}), (0, s.jsx)("span", {}) ]
                        })
                    }) ]
                }), (0, s.jsx)("ul", {
                    className: Ge()["dropdown-content"],
                    onClick: function() {
                        n(!1);
                    },
                    children: t
        ...
        var Ke = i(7648), $e = i.n(Ke);
        function Ze(e) {
            let {id: t, label: i, url: a, callback: l, itemClass: n} = e;
            return (0, s.jsx)("li", {
                className: Be()($e()["navbar-item"], n),
                onClick: l,
                children: (0, s.jsx)(je, {
                    to: a,
                    id: t,
        ...
        function Ye(e) {
            ...
            const a = [], l = [];
            return Object.keys(ze).forEach((e => {
                1 === ze[e].priority ? a.push(e) : 2 === ze[e].priority && l.push(e);
            })), (0, s.jsxs)("ul", {
                className: $e()["navbar-list"],
                children: [ a.map((e => (0, s.jsx)(Ze, {
                    id: "".concat(i, "-").concat(e, "-link"),
                    label: ze[e].name,
                    url: ze[e].url,
                    callback: t
                }, e))), l.length > 0 ? (0, s.jsx)("li", {
                    className: $e()["navbar-item"],
                    children: (0, s.jsx)(Je, {
                        animatedIconClass: $e()["navbar-label-icon"],
                        children: l.map((e => (0, s.jsx)(Ze, {
                            id: "".concat(i, "-").concat(e, "-link"),
                            label: ze[e].name,
                            url: ze[e].url,
                            callback: t,
                            itemClass: $e()["navbar-dropdown-item"]
                        }, e)))
                    })
                }) : null ]
            });
        ...
        var lt = i(3228), nt = i.n(lt);
        function rt(e) {
            let {id: t} = e;
            return (0, s.jsx)("div", {
                className: nt()["icons-group"],
                children: (0, s.jsxs)("ul", {
                    className: nt()["icons-group-list"],
                    children: [ (0, s.jsx)("li", {
                        className: nt()["icons-group-item"],
                        children: (0, s.jsx)("a", {
                            href: at.facebook.href,
                            id: "".concat(t, "-facebook"),
                            children: (0, s.jsx)("div", {
                                className: nt()["group-icon"],
                                children: (0, s.jsx)(et, {})
                            })
                        })
                    }), (0, s.jsx)("li", {
        ...
        var ut = i(4195), ct = i.n(ut);
        function ot(e) {
            let {callback: t} = e;
            const i = K(), [a, n] = (0, l.useState)(!1);
            function r() {
                let e = .01 * window.innerHeight;
                document.documentElement.style.setProperty("--vh", "".concat(e, "px"));
            }
            return (0, l.useEffect)((() => (r(), window.addEventListener("resize", r), () => {
                ...
                children: [ (0, s.jsx)("input", {
                    ...
                    htmlFor: $e()["navbar-toggle"],
                    className: $e()["navbar-label"],
                    children: [ (0, s.jsx)("span", {
                        className: "visually-hidden",
                        children: "Navbar Toggle"
                    }), (0, s.jsx)("div", {
                        className: Be()($e()["navbar-label-icon"], "animated-icon", "hamburger-icon"),
                    ...
                    className: $e()["navbar-active-path"],
                    children: i.pathname.split("/")[1]
                }), (0, s.jsxs)("div", {
                    className: $e()["navbar-content"],
                    children: [ (0, s.jsx)(Ye, {
                        id: "navbar-navlist",
                        callback: function() {
                            n(!1);
                    ...
                    children: (0, s.jsxs)("div", {
                        ...
                        children: [ (0, s.jsx)("div", {
                            ...
                            children: (0, s.jsx)("button", {
                                id: "login-button",
                                className: Be()(dt().button, dt()["secondary-button"], ct()["nav-button"]),
                                onClick: function() {
                                    console.log("logIn()");
                                },
                                children: He.label
        ...
        var ht = i(6427), gt = i.n(ht);
        function vt(e) {
            let {children: t} = e;
            return (0, s.jsx)("main", {
                className: gt()["page-main"],
                id: "content",
                children: t
            });
        }
        var bt = i(4355), qt = i.n(bt);
        function ft(e) {
            ...
            return (0, l.useEffect)((() => {
                ...
                className: qt()["toggle-outer"],
                children: [ (0, s.jsx)("div", {
                    className: qt()["toggle-description"],
                    children: t
                }), (0, s.jsx)("div", {
                    className: qt()["toggle-container"],
                    children: (0, s.jsxs)("label", {
                        ...
                        children: [ (0, s.jsx)("input", {
                            ...
                            checked: n,
                            onChange: function(e) {
                                r(e.target.checked), i(e);
                            }
                        }), (0, s.jsx)("span", {
                            className: qt().switch
                        }), (0, s.jsxs)("div", {
                            className: "visually-hidden",
                            children: [ "selected: ", n ? "true" : "false" ]
                        }) ]
                    })
                }) ]
            });
        }
        var wt = i(3475), _t = i.n(wt);
        function yt(e) {
            let {onClose: t} = e;
            const [i, a] = (0, l.useState)(!1);
            return (0, l.useEffect)((() => {
                a(document.body.classList.contains("reduced-motion"));
            }), []), (0, s.jsxs)("div", {
                id: "settings",
                className: Be()(_t().dialog, _t().open),
                children: [ (0, s.jsx)("button", {
                    id: "close-dialog-link",
                    className: _t()["dialog-close-button"],
                    onClick: t,
                    title: "Close Button",
                    children: (0, s.jsx)("div", {
                        className: Be()(_t()["dialog-close-button-icon"], "animated-icon", "close-icon", "hover"),
                        title: "Close Icon",
                        children: (0, s.jsxs)("span", {
                            className: "animated-icon-inner",
                            children: [ (0, s.jsx)("span", {}), (0, s.jsx)("span", {}) ]
                    ...
                    className: _t()["dialog-header"],
                    children: (0, s.jsx)("h2", {
                        children: "Settings"
                    })
                }), (0, s.jsx)("section", {
                    className: _t()["dialog-body"],
                    children: (0, s.jsx)("div", {
                        className: _t()["dialog-item"],
                        children: (0, s.jsx)(ft, {
        ...
        var Pt = i(6915), Nt = i.n(Pt);
        function Et() {
            const e = Object.keys(ze).reduce(((e, t) => (e.push(t), e)), []);
            return (0, s.jsx)("div", {
                className: Nt().sitemap,
                children: (0, s.jsx)("ul", {
                    className: Nt()["sitemap-list"],
                    children: e.map((e => (0, s.jsxs)("li", {
                        className: Nt()["sitemap-item"],
                        children: [ (0, s.jsx)(je, {
                            to: ze[e].url,
                            className: e => {
                                let {isActive: t} = e;
                            ...
                            children: (0, s.jsx)("h4", {
                                className: Nt()["sitemap-header"],
                                children: ze[e].name
                            })
                        }), (0, s.jsx)("ul", {
                            className: Nt()["sitemap-sublist"],
                            children: ze[e].sections.map((t => (0, s.jsx)("li", {
                                className: Nt()["sitemap-subitem"],
                                children: (0, s.jsx)(Ue, {
                                    to: "".concat(ze[e].url, "#").concat(t.id),
                                    children: t.name
                                })
                            }, "sitemap-section".concat(t.id))))
                        }) ]
                    }, "sitemap-page-".concat(ze[e].name))))
                })
            });
        }
        var St = i(3099), kt = i.n(St);
        function At() {
            const [e, t] = (0, l.useState)(!1);
            return (0, s.jsxs)(s.Fragment, {
                children: [ (0, s.jsxs)("footer", {
                    className: kt()["page-footer"],
                    children: [ (0, s.jsx)("div", {
                        className: kt()["footer-row"],
                        children: (0, s.jsx)("div", {
                            className: kt()["footer-column-center"],
                            children: (0, s.jsx)(Et, {})
                        })
                    }), (0, s.jsx)("div", {
                        className: kt()["footer-row"],
                        children: (0, s.jsx)("div", {
                            className: kt()["footer-column-center"],
                            children: (0, s.jsx)("div", {
                                className: kt()["footer-links"],
                                children: (0, s.jsx)("ul", {
                                    className: kt()["footer-links-list"],
                                    children: Object.keys(st).map((e => {
                                        const t = st[e];
                                        return (0, s.jsx)("li", {
                                            className: kt()["footer-links-item"],
                                            children: (0, s.jsx)("a", {
                                                href: t.href,
                        ...
                        className: kt()["footer-row"],
                        children: [ (0, s.jsx)("div", {
                            className: kt()["footer-column-left"],
                            children: (0, s.jsx)(rt, {
                                id: "footer-social-icons"
                            })
                        }), (0, s.jsxs)("div", {
                            className: kt()["footer-column-center"],
                            children: [ "© ", (new Date).getFullYear(), " No Rights Reserved" ]
                        }), (0, s.jsx)("div", {
                            className: kt()["footer-column-right"],
                            children: (0, s.jsx)(xt, {
                                onClick: function() {
                                    t(!0);
                                },
                ...
                }), e ? (0, Ne.createPortal)((0, s.jsx)(yt, {
                    onClose: function() {
                        t(!1);
                    }
        ...
        var Ct = i(8466), Mt = i.n(Ct);
        function It(e) {
            let {message: t, onClose: i} = e;
            if (!t) return null;
            const {title: a, description: l} = t;
            return (0, s.jsxs)("div", {
                className: Be()(Mt().message, Mt().open),
                children: [ (0, s.jsx)("button", {
                    id: "close-message-link",
                    className: Mt()["message-close-button"],
                    onClick: i,
                    title: "Close Button",
                    children: (0, s.jsx)("div", {
                        className: Be()(Mt()["message-close-button-icon"], "animated-icon", "close-icon", "hover"),
                        title: "Close Icon",
                        children: (0, s.jsxs)("span", {
                            className: "animated-icon-inner",
                            children: [ (0, s.jsx)("span", {}), (0, s.jsx)("span", {}) ]
                    ...
                    className: Mt()["message-header"],
                    children: (0, s.jsx)("h2", {
                        children: a
                    })
                }) : null, (0, s.jsx)("section", {
                    className: Mt()["message-body"],
                    children: (0, s.jsx)("div", {
                        className: Mt()["message-description"],
                        children: l
                    })
                }) ]
            });
        ...
        function Tt(e) {
            ...
            const r = (0, l.useRef)(null), {pathname: u} = K();
            return (0, l.useEffect)((() => {
                var e;
                ...
                children: [ (0, s.jsx)(Ue, {
                    ...
                    className: gt().page,
                    ref: r,
                    children: [ (0, s.jsx)(Oe, {}), (0, s.jsx)(pt, {}), a ? (0, s.jsx)(It, {
                        message: ze[i].message,
                        onClose: function() {
                            n(!1);
                        }
                    }) : null, (0, s.jsx)(vt, {
        ...
        var Bt = i(9929), zt = i.n(Bt);
        function Ht(e) {
            let {tag: t} = e;
            return t ? (0, s.jsxs)("div", {
                className: Be()(zt()["article-image-tag"], zt()[t.type]),
                children: [ "breaking" === t.type ? (0, s.jsx)(Ft, {}) : null, "watch" === t.type ? (0, 
                s.jsx)(Ot, {}) : null, "new" === t.type ? (0, s.jsx)(Dt, {}) : null, (0, s.jsx)(Rt, {
                    text: t.label
                }) ]
            }) : null;
        }
        function Wt(e) {
            ...
            return t ? (0, s.jsxs)(s.Fragment, {
                children: [ (0, s.jsxs)("div", {
                    ...
                    textClass: zt()["article-image-captions"],
        ...
        function Kt() {
            if (!Gt && (Gt = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto), 
            !Gt)) throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
            return Gt(Jt);
        }
        const $t = [];
        ...
        function Xt(e) {
            ...
            return "text" === t ? (0, s.jsx)("div", {
                className: zt()["article-content"],
                children: (0, s.jsx)(Rt, {
                    text: i
                })
            }) : "list" === t ? (0, s.jsx)("div", {
                className: zt()["article-content"],
                children: (0, s.jsx)("ul", {
                    className: Be()(zt()["article-list"], zt().vertical, {
                        [zt()[a]]: a
                    }),
                    children: i.map((e => (0, s.jsx)("li", {
                        className: zt()["article-list-item"],
                        children: e.url && !e.title ? (0, s.jsx)("a", {
                            href: e.url,
                            children: (0, s.jsx)(Rt, {
                                text: e.content
                            })
            ...
            }) : "articles-list" === t ? (0, s.jsx)("div", {
                className: zt()["article-list-content"],
                children: (0, s.jsx)("ul", {
                    className: Be()(zt()["article-list"], zt().vertical),
                    children: i.map((e => (0, s.jsxs)("li", {
                        className: zt()["article-list-item"],
                        children: [ (0, s.jsx)(Rt, {
                            textClass: Be()(zt()["article-title"], "truncate-multiline", "truncate-multiline-3"),
                            text: e.title,
                            type: "h3"
                        }), e.url && !e.title ? (0, s.jsx)("a", {
                            href: e.url,
                            children: (0, s.jsx)(Rt, {
                                text: e.content
                            })
            ...
            }) : "excerpt" === t ? (0, s.jsx)("ul", {
                className: Be()(zt()["article-list"], zt().horizontal),
                children: i.map((e => (0, s.jsxs)("li", {
                    className: zt()["article-list-item"],
                    children: [ (0, s.jsx)(Wt, {
                        imageClass: zt()["article-hero"],
                        image: e.image
                    }), (0, s.jsx)("div", {
                        className: zt()["article-content"],
                        children: (0, s.jsx)(Rt, {
                ...
                className: Be()(gt()["grid-container"], {
                    [gt()[a]]: a
                }),
                children: i.map((e => (0, s.jsxs)("div", {
                    className: gt()["grid-item"],
                    children: [ (0, s.jsx)(Wt, {
                        imageClass: zt()["article-image-container"],
                        image: e.image,
                        meta: e.meta
                    }), e.url ? (0, s.jsx)("a", {
                        href: e.url,
                        children: (0, s.jsx)(Rt, {
                            textClass: Be()(zt()["article-content"], "truncate-multiline", "truncate-multiline-3"),
                            text: e.text,
                            type: "h3"
                        })
                    }) : (0, s.jsx)(Rt, {
        ...
        function ei(e) {
            ...
            return (0, s.jsxs)("article", {
                className: Be()(gt().column, gt()[t.class], zt().article),
                children: [ (0, s.jsx)(Lt, {
                    headerClass: zt()["article-header"],
                    text: t.header,
                    link: t.url
                }), (0, s.jsxs)("section", {
                    className: zt()["article-body"],
                    children: [ (0, s.jsx)(Wt, {
                        imageClass: zt()["article-image-container"],
                        image: t.image,
                        meta: t.meta
                    }), (0, s.jsx)(Rt, {
                        textClass: Be()(zt()["article-title"], "truncate-singleline"),
                        text: t.title,
                        type: "h3"
                    }), (0, s.jsx)(Xt, {
                        type: t.type,
        ...
        function ti(e) {
            let {section: t} = e;
            return (0, s.jsxs)(s.Fragment, {
                children: [ t.name ? (0, s.jsx)("div", {
                    id: t.id,
                    className: gt()["row-header"],
                    children: (0, s.jsx)("h2", {
                        children: t.name
                    })
                }) : null, (0, s.jsx)("section", {
                    className: gt().row,
                    children: t.articles.map(((e, i) => (0, s.jsx)(ei, {
                        article: e
                    }, "".concat(t.id, "-").concat(i))))
                }) ]
            });
        }
        var ii = i(2824), ai = i.n(ii);
        function si(e) {
            let {onClose: t, notification: i, onAccept: a, onReject: l} = e;
            const {title: n, description: r, actions: u} = i;
            return (0, s.jsxs)("div", {
                className: Be()(ai().toast, ai().open),
                children: [ (0, s.jsx)("button", {
                    id: "close-toast-link",
                    className: ai()["toast-close-button"],
                    onClick: t,
                    title: "Close Button",
                    children: (0, s.jsx)("div", {
                        className: Be()(ai()["toast-close-button-icon"], "animated-icon", "close-icon", "hover"),
                        title: "Close Icon",
                        children: (0, s.jsxs)("span", {
                            className: "animated-icon-inner",
                            children: [ (0, s.jsx)("span", {}), (0, s.jsx)("span", {}) ]
                    ...
                    className: ai()["toast-header"],
                    children: (0, s.jsx)("h2", {
                        children: n
                    })
                }) : null, (0, s.jsxs)("section", {
                    className: ai()["toast-body"],
                    children: [ (0, s.jsx)("div", {
                        className: ai()["toast-description"],
                        children: r
                    }), (0, s.jsx)("div", {
                        className: ai()["toast-actions"],
                        children: u.map((e => {
                            const t = "toast-".concat(e.type, "-button");
                            return (0, s.jsx)("button", {
                                id: t,
                                className: Be()(dt().button, dt()["".concat(e.priority, "-button")], ai()["toast-actions-button"]),
        ...
        function li(e) {
            ...
            return (0, l.useEffect)((() => {
                ...
                children: [ (0, s.jsx)(Tt, {
                    id: t,
                    children: ze[t].sections.map((e => (0, s.jsx)(ti, {
                        section: e
                    }, e.id)))
                }), i && ze[t].notification ? (0, Ne.createPortal)((0, s.jsx)(si, {
                    notification: ze[t].notification,
                    onAccept: function() {
                        n();
                    },
                    onReject: r,
        ...
        var ni = i(9008), ri = i.n(ni);
        function ui() {
            return (0, s.jsxs)(s.Fragment, {
                children: [ (0, s.jsxs)(ri(), {
                    children: [ (0, s.jsx)("title", {
                        children: "The Daily Broadcast"
                    }), (0, s.jsx)("meta", {
                        name: "description",
