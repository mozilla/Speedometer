...
if (typeof module != 'undefined')
    module.exports.AsyncTask = AsyncTask;class LazilyEvaluatedFunction {
...
class ButtonBase extends ComponentBase {
    ...
    static cssTemplate()
    {
        ...
        return ` :host{display:inline-block;width:${sizeFactor}rem;height:${sizeFactor}rem}a{vertical-align:bottom;display:block;opacity:0.3}a:hover{opacity:0.6}a[disabled]{pointer-events:none;cursor:default;opacity:0.2}svg{display:block}`;
    }
}
...
class OwnedCommitViewer extends ComponentBase {
    ...
    static cssTemplate() {
        return ` :host{display:block;font-size:0.8rem;font-weight:normal}expand-collapse-button{margin-left:calc(50% - 0.8rem);display:block}td,th{padding:0.2rem;margin:0;border-top:solid 1px #ccc}#difference-table{width:100%}#spinner-container{text-align:center}`;
    }
}
...
ComponentBase.defineElement('instant-file-uploader', InstantFileUploader);class FreshnessIndicator extends ComponentBase {
