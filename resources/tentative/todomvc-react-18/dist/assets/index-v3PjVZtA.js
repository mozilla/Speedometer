...
function createBox(options = {}) {
  ...
  const Box2 = /* @__PURE__ */ reactExports.forwardRef(function Box3(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps), {
      className,
      component = "div"
    } = _extendSxProp, other = _objectWithoutPropertiesLoose$1(_extendSxProp, _excluded$M);
...
function createStyled(input = {}) {
  ...
  return (tag, inputOptions = {}) => {
    ...
    } = inputOptions, options = _objectWithoutPropertiesLoose$1(inputOptions, _excluded$K);
    ...
    const muiStyledResolver = (styleArg, ...expressions) => {
      ...
      if (componentName && overridesResolver2) {
        expressionsWithDefaultTheme.push((props) => {
          const theme2 = resolveTheme(_extends$3({}, props, {
            defaultTheme: defaultTheme2,
            themeId
          }));
...
function createPalette(palette) {
  const {
    ...
    contrastThreshold = 3,
    tonalOffset = 0.2
  } = palette, other = _objectWithoutPropertiesLoose$1(palette, _excluded$J);
...
function createTypography(palette, typography) {
  const _ref = typeof typography === "function" ? typography(palette) : typography, {
    ...
    allVariants,
    pxToRem: pxToRem2
  } = _ref, other = _objectWithoutPropertiesLoose$1(_ref, _excluded$I);
...
function createTransitions(inputTransitions) {
  ...
  const create = (props = ["all"], options = {}) => {
    ...
    _objectWithoutPropertiesLoose$1(options, _excluded$H);
...
function ThemeProvider(_ref) {
  let {
    theme: themeInput
  } = _ref, props = _objectWithoutPropertiesLoose$1(_ref, _excluded$F);
...
function createSvgIcon$1(path, displayName) {
  function Component(props, ref) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SvgIcon, _extends$3({
...
const Badge = /* @__PURE__ */ reactExports.forwardRef(function Badge2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(RootSlot, _extends$3({}, rootProps, {
    children: [children, /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeSlot, _extends$3({}, badgeProps, {
...
const _excluded$s = ["children", "className", "component", "onChange", "showLabels", "value"];
...
const BottomNavigation = /* @__PURE__ */ reactExports.forwardRef(function BottomNavigation2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNavigationRoot, _extends$3({
    as: component,
    className: clsx(classes.root, className),
    ref,
    ownerState
...
const _excluded$r = ["className", "icon", "label", "onChange", "onClick", "selected", "showLabel", "value"];
...
const BottomNavigationAction = /* @__PURE__ */ reactExports.forwardRef(function BottomNavigationAction2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(BottomNavigationActionRoot, _extends$3({
    ref,
    className: clsx(classes.root, className),
    focusRipple: true,
...
const html = (theme2, enableColorScheme) => _extends$3({
...
const _excluded$e = ["alignItems", "autoFocus", "component", "children", "dense", "disableGutters", "divider", "focusVisibleClassName", "selected", "className"];
...
const ListItemButton = /* @__PURE__ */ reactExports.forwardRef(function ListItemButton2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ListContext$1.Provider, {
    value: childContext,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemButtonRoot, _extends$3({
      ref: handleRef,
...
const ListItemSecondaryAction = /* @__PURE__ */ reactExports.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemSecondaryActionRoot, _extends$3({
    className: clsx(classes.root, className),
    ownerState,
    ref
  }, other));
...
const _excluded$c = ["className"], _excluded2$3 = ["alignItems", "autoFocus", "button", "children", "className", "component", "components", "componentsProps", "ContainerComponent", "ContainerProps", "dense", "disabled", "disableGutters", "disablePadding", "divider", "focusVisibleClassName", "secondaryAction", "selected", "slotProps", "slots"];
...
const ListItem = /* @__PURE__ */ reactExports.forwardRef(function ListItem2(inProps, ref) {
  ...
  const {
    ...
    slotProps = {},
    slots = {}
  } = props, ContainerProps = _objectWithoutPropertiesLoose$1(props.ContainerProps, _excluded$c), other = _objectWithoutPropertiesLoose$1(props, _excluded2$3);
  const context = reactExports.useContext(ListContext$1);
  const childContext = reactExports.useMemo(() => ({
    dense: dense || context.dense || false,
    alignItems,
  ...
  if (hasSecondaryAction) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ListContext$1.Provider, {
      value: childContext,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ListItemContainer, _extends$3({
        as: ContainerComponent,
        className: clsx(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState
      }, ContainerProps, {
        children: [/* @__PURE__ */ jsxRuntimeExports.jsx(Root, _extends$3({}, rootProps, !isHostComponent(Root) && {
          as: Component,
          ownerState: _extends$3({}, ownerState, rootProps.ownerState)
        }, componentProps, {
          children
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ListContext$1.Provider, {
    value: childContext,
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Root, _extends$3({}, rootProps, {
      as: Component,
      ref: handleRef
...
const ListItemIcon = /* @__PURE__ */ reactExports.forwardRef(function ListItemIcon2(inProps, ref) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemIconRoot, _extends$3({
    className: clsx(classes.root, className),
    ownerState,
    ref
  }, other));
...
const _excluded$8 = ["onEntering"], _excluded2$2 = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], _excluded3$1 = ["slotProps"];
...
const _excluded = ["onClick", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset", "unstable_viewTransition"], _excluded3 = ["fetcherKey", "navigate", "reloadDocument", "replace", "state", "method", "action", "onSubmit", "relative", "preventScrollReset", "unstable_viewTransition"];
...
function TodoTestActions() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box$1, { sx: { padding: 1 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Form, { action: "/api/todos/benchmark/populate", method: "post", navigate: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "contained", type: "submit", className: "add-lots-of-items-button", children: "Add lots of items" }) }) });
}
var Add = {};
...
var default_1$5 = KeyboardDoubleArrowDown.default = void 0;
var _createSvgIcon$5 = _interopRequireDefault$5(requireCreateSvgIcon());
var _jsxRuntime$5 = jsxRuntimeExports;
default_1$5 = KeyboardDoubleArrowDown.default = (0, _createSvgIcon$5.default)([/* @__PURE__ */ (0, _jsxRuntime$5.jsx)("path", {
...
function TodoInput() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box$1, { sx: { display: "flex", alignItems: "center" }, children: [
    hasTodos ? /* @__PURE__ */ jsxRuntimeExports.jsx(fetcher.Form, { action: "/api/todos/toggleAll", method: "post", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton$1, { type: "submit", "aria-label": areAllCompleted ? "Reset all entries" : "Mark all entries as completed", sx: areAllCompleted ? { color: "black" } : null, name: "value", value: String(!areAllCompleted), children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$5, {}) }) }) : null,
...
default_1$4 = Edit.default = (0, _createSvgIcon$4.default)(/* @__PURE__ */ (0, _jsxRuntime$4.jsx)("path", {
...
const TodoItem = reactExports.memo(function({ todoId, todoText, todoDone, onToggle }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ListItem$1,
    {
      secondaryAction: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton$1, { edge: "end", "aria-label": "edit", onClick: () => setEdit(!edit), children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$4, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton$1, { edge: "end", "aria-label": "remove", type: "submit", formAction: `/api/todos/${todoId}/remove`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$3, {}) })
      ] }),
      disablePadding: true,
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(ListItemButton$1, { role: void 0, sx: {
        marginRight: "40px"
        /* The margin compensates for the 2 icons in secondaryAction */
      }, onClick: () => onToggle(todoId), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemIcon$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Checkbox$1, { edge: "start", checked: todoDone, tabIndex: -1, inputProps: { "aria-labelledby": labelId } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ListItemText$1, { id: labelId, primary: todoText })
      ] })
    }
  );
});
function TodoList() {
  const { filteredTodos } = useLoaderData();
  const fetcher = useFetcher();
  const onTodoToggle = reactExports.useCallback((todoId) => fetcher.submit(null, { action: `/api/todos/${todoId}/toggle`, method: "POST" }), [fetcher.submit]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(List$1, { children: filteredTodos.map((todo) => /* @__PURE__ */ jsxRuntimeExports.jsxs(fetcher.Form, { action: `/api/todos/${todo.id}/setText`, method: "POST", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "submit", style: { display: "none" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TodoItem, { todoId: todo.id, todoText: todo.text, todoDone: todo.done, onToggle: onTodoToggle }, todo.text)
  ] }, todo.id)) });
}
var Done = {};
...
var default_1$2 = Done.default = void 0;
var _createSvgIcon$2 = _interopRequireDefault$2(requireCreateSvgIcon());
var _jsxRuntime$2 = jsxRuntimeExports;
default_1$2 = Done.default = (0, _createSvgIcon$2.default)(/* @__PURE__ */ (0, _jsxRuntime$2.jsx)("path", {
...
var default_1$1 = FormatListBulleted.default = void 0;
var _createSvgIcon$1 = _interopRequireDefault$1(requireCreateSvgIcon());
var _jsxRuntime$1 = jsxRuntimeExports;
default_1$1 = FormatListBulleted.default = (0, _createSvgIcon$1.default)(/* @__PURE__ */ (0, _jsxRuntime$1.jsx)("path", {
...
Object.defineProperty(Alarm, "__esModule", {
  value: true
});
var default_1 = Alarm.default = void 0;
var _createSvgIcon = _interopRequireDefault(requireCreateSvgIcon());
var _jsxRuntime = jsxRuntimeExports;
default_1 = Alarm.default = (0, _createSvgIcon.default)(/* @__PURE__ */ (0, _jsxRuntime.jsx)("path", {
...
function TodoNav() {
  const { filter, allTodos } = useLoaderData();
  if (!allTodos.length) {
    return null;
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Paper$1, { elevation: 1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BottomNavigation$1, { showLabels: true, value: filter, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNavigationAction$1, { value: "all", label: "All", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$1, {}), component: Link, to: "/" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      BottomNavigationAction$1,
      {
        value: "active",
        label: "Active",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge$1, { badgeContent: pendingCount, color: "primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1, { "aria-label": `${pendingCount} pending items` }) }),
        component: Link,
        to: "/active"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      BottomNavigationAction$1,
      {
        value: "completed",
        label: "Completed",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge$1, { badgeContent: completedCount, color: "success", children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$2, { "aria-label": `${completedCount} completed items` }) }),
        component: Link,
        to: "/completed"
      }
    )
...
function TodoExtraActions() {
  ...
  return hasCompletedItems ? /* @__PURE__ */ jsxRuntimeExports.jsx(Box$1, { sx: { width: "100%", textAlign: "right" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Form, { method: "post", action: "/api/todos/removeCompleted", navigate: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { type: "submit", children: "Clear completed items" }) }) }) : null;
}
function TodoListPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TodoTestActions, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Paper$1, { elevation: 1, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TodoInput, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TodoList, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TodoExtraActions, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TodoNav, {})
    ] })
  ] });
}
let todos = [];
...
function toggleTodo(todoId) {
  const todo = todos.find(({ id: id2 }) => id2 === todoId);
  if (!todo)
    return false;
  todo.done = !todo.done;
  return true;
...
function removeTodo(todoId) {
  const todoIndex = todos.findIndex(({ id: id2 }) => id2 === todoId);
  if (todoIndex < 0) {
    return false;
  }
...
const router = createHashRouter([
  {
    path: "/:filter?",
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(TodoListPage, {}),
    loader
  },
  {
    path: "/api/todos",
